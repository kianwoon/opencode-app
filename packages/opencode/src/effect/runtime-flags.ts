...
export class Service extends ConfigService.Service<Service>()("@opencode/RuntimeFlags", {
  ...
  disableSecretBroker: bool("OPENCODE_DISABLE_SECRET_BROKER"),
  disableExecutionGuard: bool("OPENCODE_DISABLE_EXECUTION_GUARD"),
  disableContextFirewall: bool("OPENCODE_DISABLE_CONTEXT_FIREWALL"),
