export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "ពណ៌អត្ថបទសាររបស់អ្នកប្រើ",
  "settings.general.row.userMessageTextColor.description": "កំណត់ពណ៌អត្ថបទសាររបស់អ្នកប្រើ",
