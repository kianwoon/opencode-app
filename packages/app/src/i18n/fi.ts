export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Viestien tekstinväri",
  "settings.general.row.userMessageTextColor.description": "Määritä käyttäjän viestien tekstinväri",
