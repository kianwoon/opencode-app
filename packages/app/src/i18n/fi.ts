export const dict = {
  ...
  "command.session.search": "Hae viestejä",
  "command.session.search.description": "Hae tämän istunnon viestejä",
  ...
  "dialog.search.empty": "Ei vastaavia viestejä",
  ...
  "sidebar.tasks.title": "Tehtävät",
  "sidebar.tasks.new": "Uusi tehtävä",
  "sidebar.tasks.loading": "Ladataan tehtäviä...",
  "sidebar.tasks.empty": "Ei ajastettuja tehtäviä",
  "sidebar.tasks.pause": "Keskeytä tehtävä",
  "sidebar.tasks.resume": "Jatka tehtävää",
  "sidebar.tasks.runNow": "Suorita nyt",
  "dialog.task.new.title": "Uusi tehtävä",
  "dialog.task.title": "Otsikko",
  "dialog.task.title.placeholder": "esim. Viikoittainen riippuvuuskatsaus",
  "dialog.task.prompt": "Kehote",
  "dialog.task.prompt.placeholder": "Mitä agentin tulee tehdä jokaisella suorituskerralla?",
  "dialog.task.cron": "Aikataulu",
  "dialog.task.cron.expression": "Cron-lauseke",
  "dialog.task.cron.preset.hourly": "Joka tunti",
  "dialog.task.cron.preset.daily": "Joka päivä",
  "dialog.task.cron.preset.weekly": "Joka viikko",
  "dialog.task.cron.preset.monthly": "Joka kuukausi",
  "dialog.task.cron.preset.custom": "Mukautettu",
  ...
  "settings.general.row.messageWidth.title": "Viestin leveys",
  "settings.general.row.messageWidth.description": "Määritä kuinka leveä käyttäjän viestit voivat olla keskustelussa",
  "settings.general.row.messageWidth.option.default": "Oletus",
  "settings.general.row.messageWidth.option.wide": "Leveä",
  ...
  "settings.general.row.messageAlign.option.center": "Keskitetty",
  "settings.general.row.messageAlign.option.right": "Oikea",
  "settings.general.row.messageBorder.title": "Viestien reunus",
  "settings.general.row.messageBorder.description": "Määritä käyttäjän viestien reunuksen väri ja paksuus",
  "settings.general.row.messageBorder.width.none": "Ei mitään",
  "settings.general.row.messageBackground.title": "Viestien tausta",
  "settings.general.row.messageBackground.description": "Määritä käyttäjän viestien taustaväri",
  "settings.general.row.userMessageFont.title": "Viestien tekstinväri",
  "settings.general.row.userMessageFont.description": "Määritä käyttäjän viestien tekstinväri",
  ...
  "settings.general.row.fontWeight.extraLight": "Erittäin vaalea",
  "settings.general.row.fontWeight.light": "Vaalea",
  "settings.general.row.fontWeight.regular": "Tavallinen",
  ...
  "settings.providers.section.routing": "Mallien reititys",
  "settings.providers.routing.title": "Reititysstrategia",
  "settings.providers.routing.description": "Miten OpenRouter valitsee taustapalveluntarjoajan jokaiselle pyynnölle.",
  ...
  "settings.plugins.plugins.add.browse": "Selaa…",
  ...
  "settings.plugins.skills.directories.title": "Taitojen kansiot",
  "settings.plugins.skills.directories.hint":
    "Kansion poistaminen käytöstä sulkee sen taidot pois löytämisestä. Tiedostot jäävät levylle.",
  "settings.plugins.skills.directories.toggle": "Vaihda taitokansion tilaa {{directory}}",
  "settings.plugins.skills.directories.disabled": "Pois",
  "settings.plugins.skills.directories.toggle.failed": "Taitokansioiden päivittäminen epäonnistui",
