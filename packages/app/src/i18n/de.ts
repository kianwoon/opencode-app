...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Textfarbe von Nutzernachrichten",
  "settings.general.row.userMessageTextColor.description": "Textfarbe von Nutzernachrichten festlegen",
