...
export const dict = {
  ...
  "command.session.search": "Nachrichten durchsuchen",
  "command.session.search.description": "Die Nachrichten in dieser Sitzung durchsuchen",
  ...
  "dialog.search.empty": "Keine übereinstimmenden Nachrichten",
  ...
  "sidebar.drop.title": "Ziehen Sie einen Ordner hierher, um ein Projekt hinzuzufügen",
  "sidebar.drop.foldersOnly": "Es können nur Ordner als Projekte hinzugefügt werden",

  "sidebar.tasks.title": "Aufgaben",
  "sidebar.tasks.new": "Neue Aufgabe",
  "sidebar.tasks.loading": "Aufgaben werden geladen...",
  "sidebar.tasks.empty": "Keine geplanten Aufgaben",
  "sidebar.tasks.pause": "Aufgabe pausieren",
  "sidebar.tasks.resume": "Aufgabe fortsetzen",
  "sidebar.tasks.runNow": "Jetzt ausführen",
  "dialog.task.new.title": "Neue Aufgabe",
  "dialog.task.title": "Titel",
  "dialog.task.title.placeholder": "z. B. Wöchentliche Abhängigkeitsprüfung",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Was soll der Agent bei jeder Ausführung tun?",
  "dialog.task.cron": "Zeitplan",
  "dialog.task.cron.expression": "Cron-Ausdruck",
  "dialog.task.cron.preset.hourly": "Stündlich",
  "dialog.task.cron.preset.daily": "Täglich",
  "dialog.task.cron.preset.weekly": "Wöchentlich",
  "dialog.task.cron.preset.monthly": "Monatlich",
  "dialog.task.cron.preset.custom": "Benutzerdefiniert",
  ...
  "settings.general.row.messageWidth.title": "Nachrichtenbreite",
  "settings.general.row.messageWidth.description": "Legen Sie fest, wie breit Nutzernachrichten im Verlauf sein können",
  "settings.general.row.messageWidth.option.default": "Standard",
  "settings.general.row.messageWidth.option.wide": "Breit",
  ...
  "settings.general.row.messageAlign.option.center": "Zentriert",
  "settings.general.row.messageAlign.option.right": "Rechts",
  "settings.general.row.messageBorder.title": "Nachrichtenrahmen",
  "settings.general.row.messageBorder.description": "Rahmenfarbe und -dicke um Nutzernachrichten festlegen",
  "settings.general.row.messageBorder.width.none": "Ohne",
  "settings.general.row.messageBackground.title": "Nachrichtenhintergrund",
  "settings.general.row.messageBackground.description": "Hintergrundfarbe von Nutzernachrichten festlegen",
  "settings.general.row.userMessageFont.title": "Textfarbe von Nutzernachrichten",
  "settings.general.row.userMessageFont.description": "Textfarbe von Nutzernachrichten festlegen",
  ...
  "settings.providers.section.routing": "Modell-Routing",
  "settings.providers.routing.title": "Routing-Strategie",
  "settings.providers.routing.description": "Wie OpenRouter den Hintergrundanbieter für jede Anfrage auswählt.",
  "settings.providers.routing.price": "Niedrigster Preis",
  "settings.providers.routing.throughput": "Höchster Durchsatz",
  "settings.providers.routing.latency": "Geringste Latenz",
  ...
  "settings.plugins.plugins.add.browse": "Durchsuchen…",
  ...
  "settings.plugins.skills.directories.title": "Skill-Verzeichnisse",
  "settings.plugins.skills.directories.hint":
    "Schalten Sie ein Verzeichnis aus, um seine Skills von der Erkennung auszuschließen. Die Dateien bleiben auf dem Datenträger erhalten.",
  "settings.plugins.skills.directories.toggle": "Skill-Verzeichnis {{directory}} umschalten",
  "settings.plugins.skills.directories.disabled": "Aus",
  "settings.plugins.skills.directories.toggle.failed": "Skill-Verzeichnisse konnten nicht aktualisiert werden",
