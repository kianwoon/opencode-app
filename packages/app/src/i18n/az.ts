export const dict = {
  ...
  "command.session.search": "Mesajları axtar",
  "command.session.search.description": "Bu sessiyadakı mesajları axtar",
  ...
  "dialog.search.empty": "Uyğun mesaj yoxdur",
  ...
  "settings.general.row.messageWidth.title": "Mesaj eni",
  "settings.general.row.messageWidth.description": "Söhbətdə istifadəçi mesajlarının nə qədər enli ola biləcəyini təyin edin",
  "settings.general.row.messageWidth.option.default": "Standart",
  "settings.general.row.messageWidth.option.wide": "Enli",
  ...
  "settings.general.row.messageAlign.option.center": "Mərkəz",
  "settings.general.row.messageAlign.option.right": "Sağ",
  "settings.general.row.messageBorder.title": "Mesaj çərçivəsi",
  "settings.general.row.messageBorder.description": "İstifadəçi mesajlarının çərçivə rəngini və qalınlığını təyin edin",
  "settings.general.row.messageBorder.width.none": "Yoxdur",
  "settings.general.row.messageBackground.title": "Mesaj fonu",
  "settings.general.row.messageBackground.description": "İstifadəçi mesajlarının fon rəngini təyin edin",
  "settings.general.row.userMessageFont.title": "İstifadəçi mesajı mətninin rəngi",
  "settings.general.row.userMessageFont.description": "İstifadəçi mesajlarının mətn rəngini təyin edin",
  ...
  "settings.providers.section.routing": "Model yönləndirməsi",
  "settings.providers.routing.title": "Yönləndirmə strategiyası",
  "settings.providers.routing.description": "OpenRouter hər sorğu üçün arxa tərəf provayderini necə seçir.",
  "settings.providers.routing.price": "Ən aşağı qiymət",
  "settings.providers.routing.throughput": "Ən yüksək ötürmə tutumu",
  "settings.providers.routing.latency": "Ən aşağı gecikmə",
  ...
  "settings.plugins.plugins.add.browse": "Göz at…",
  ...
  "settings.plugins.skills.directories.title": "Bacarıq qovluqları",
  "settings.plugins.skills.directories.hint":
    "Qovluğu söndürmək onun bacarıqlarını aşkarlamadan çıxarır. Fayllar diskdə qalır.",
  "settings.plugins.skills.directories.toggle": "{{directory}} bacarıq qovluğunu dəyişdir",
  "settings.plugins.skills.directories.disabled": "Deaktiv",
  "settings.plugins.skills.directories.toggle.failed": "Bacarıq qovluqlarını yeniləmək alınmadı",
