export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "İstifadəçi mesajı mətninin rəngi",
  "settings.general.row.userMessageTextColor.description": "İstifadəçi mesajlarının mətn rəngini təyin edin",
