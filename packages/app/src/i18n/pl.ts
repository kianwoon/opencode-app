export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Kolor tekstu wiadomości użytkownika",
  "settings.general.row.userMessageTextColor.description": "Ustaw kolor tekstu wiadomości użytkownika",
