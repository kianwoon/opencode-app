export const dict = {
  ...
  "command.session.search": "Szukaj wiadomości",
  "command.session.search.description": "Szukaj wiadomości w tej sesji",
  ...
  "dialog.search.empty": "Brak pasujących wiadomości",
  ...
  "sidebar.tasks.title": "Zadania",
  "sidebar.tasks.new": "Nowe zadanie",
  "sidebar.tasks.loading": "Wczytywanie zadań...",
  "sidebar.tasks.empty": "Brak zaplanowanych zadań",
  "sidebar.tasks.pause": "Wstrzymaj zadanie",
  "sidebar.tasks.resume": "Wznów zadanie",
  "sidebar.tasks.runNow": "Uruchom teraz",
  "dialog.task.new.title": "Nowe zadanie",
  "dialog.task.title": "Tytuł",
  "dialog.task.title.placeholder": "np. Cotygodniowy przegląd zależności",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Co agent ma robić przy każdym uruchomieniu?",
  "dialog.task.cron": "Harmonogram",
  "dialog.task.cron.expression": "Wyrażenie cron",
  "dialog.task.cron.preset.hourly": "Co godzinę",
  "dialog.task.cron.preset.daily": "Codziennie",
  "dialog.task.cron.preset.weekly": "Co tydzień",
  "dialog.task.cron.preset.monthly": "Co miesiąc",
  "dialog.task.cron.preset.custom": "Niestandardowe",
  ...
  "settings.general.row.messageWidth.title": "Szerokość wiadomości",
  "settings.general.row.messageWidth.description": "Ustaw jak szerokie mogą być wiadomości użytkownika w rozmowie",
  "settings.general.row.messageWidth.option.default": "Domyślnie",
  "settings.general.row.messageWidth.option.wide": "Szerokie",
  ...
  "settings.general.row.messageAlign.option.center": "Do środka",
  "settings.general.row.messageAlign.option.right": "Prawo",
  "settings.general.row.messageBorder.title": "Obramowanie wiadomości",
  "settings.general.row.messageBorder.description": "Ustaw kolor i grubość obramowania wiadomości użytkownika",
  "settings.general.row.messageBorder.width.none": "Brak",
  "settings.general.row.messageBackground.title": "Tło wiadomości",
  "settings.general.row.messageBackground.description": "Ustaw kolor tła wiadomości użytkownika",
  "settings.general.row.userMessageFont.title": "Kolor tekstu wiadomości użytkownika",
  "settings.general.row.userMessageFont.description": "Ustaw kolor tekstu wiadomości użytkownika",
  ...
  "settings.general.row.fontWeight.extraLight": "Extra jasny",
  "settings.general.row.fontWeight.light": "Jasny",
  "settings.general.row.fontWeight.regular": "Zwykły",
  ...
  "settings.providers.section.routing": "Routing modeli",
  "settings.providers.routing.title": "Strategia routingu",
  "settings.providers.routing.description": "Jak OpenRouter wybiera dostawcę zapasowego dla każdego żądania.",
  "settings.providers.routing.price": "Najniższa cena",
  "settings.providers.routing.throughput": "Największa przepustowość",
  ...
  "settings.plugins.plugins.add.browse": "Przeglądaj…",
  ...
  "settings.plugins.skills.directories.title": "Foldery umiejętności",
  "settings.plugins.skills.directories.hint":
    "Wyłączenie folderu wyklucza jego umiejętności z wykrywania. Pliki pozostają na dysku.",
  "settings.plugins.skills.directories.toggle": "Przełącz folder umiejętności {{directory}}",
  "settings.plugins.skills.directories.disabled": "Wył.",
  "settings.plugins.skills.directories.toggle.failed": "Nie udało się zaktualizować folderów umiejętności",
  ...
  "settings.plugins.plugins.count.few": "{{count}} wtyczki",
  "settings.plugins.plugins.count.many": "{{count}} wtyczek",
  "settings.plugins.skills.count.few": "{{count}} umiejętności",
  "settings.plugins.skills.count.many": "{{count}} umiejętności",
