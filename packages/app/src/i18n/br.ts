export const dict = {
  ...
  "command.session.search": "Pesquisar mensagens",
  "command.session.search.description": "Pesquisar as mensagens desta sessão",
  ...
  "dialog.search.empty": "Nenhuma mensagem correspondente",
  ...
  "sidebar.drop.title": "Arraste uma pasta aqui para adicionar um projeto",
  "sidebar.drop.foldersOnly": "Somente pastas podem ser adicionadas como projetos",
  ...
  "settings.general.row.messageWidth.title": "Ledander ar c'hemennadoù",
  "settings.general.row.messageWidth.description": "Arventennañ pe genñder e c'hall bezañ kemennadoù an implijer er gaozeadenn",
  "settings.general.row.messageWidth.option.default": "Dre ziouer",
  "settings.general.row.messageWidth.option.wide": "Ledan",
  ...
  "settings.general.row.messageAlign.option.center": "Kreiz",
  "settings.general.row.messageAlign.option.right": "Dehou",
  "settings.general.row.messageBorder.title": "Riblenn ar c'hemennadoù",
  "settings.general.row.messageBorder.description": "Arventennañ liv ha treutder riblenn kemennadoù an implijer",
  "settings.general.row.messageBorder.width.none": "Hini ebet",
  "settings.general.row.messageBackground.title": "Drekleur ar c'hemennadoù",
  "settings.general.row.messageBackground.description": "Arventennañ liv drekleur kemennadoù an implijer",
  "settings.general.row.userMessageFont.title": "Liv test kemennadoù an implijer",
  "settings.general.row.userMessageFont.description": "Arventennañ liv test kemennadoù an implijer",
  ...
  "settings.providers.section.routing": "Routañ ar c'hodelioù",
  "settings.providers.routing.title": "Strategiezh routañ",
  "settings.providers.routing.description": "Penaos e tibab OpenRouter ar pourchaser dreklek evit pep reked.",
  "settings.providers.routing.price": "Priz izelañ",
  "settings.providers.routing.throughput": "Kas uc'heañ",
  "settings.providers.routing.latency": "Hencher izelañ",
  ...
  "settings.plugins.plugins.add.browse": "Furchal…",
