export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Liv test kemennadoù an implijer",
  "settings.general.row.userMessageTextColor.description": "Arventennañ liv test kemennadoù an implijer",
