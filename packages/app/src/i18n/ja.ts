export const dict = {
  ...
  "command.session.search": "メッセージを検索",
  "command.session.search.description": "このセッション内のメッセージを検索",
  ...
  "dialog.search.empty": "一致するメッセージがありません",
  ...
  "sidebar.drop.title": "プロジェクトを追加するにはフォルダをここにドロップ",
  "sidebar.drop.foldersOnly": "プロジェクトとして追加できるのはフォルダのみです",

  "sidebar.tasks.title": "タスク",
  "sidebar.tasks.new": "新規タスク",
  "sidebar.tasks.loading": "タスクを読み込み中...",
  "sidebar.tasks.empty": "予定されたタスクはありません",
  "sidebar.tasks.pause": "タスクを一時停止",
  "sidebar.tasks.resume": "タスクを再開",
  "sidebar.tasks.runNow": "今すぐ実行",
  "dialog.task.new.title": "新規タスク",
  "dialog.task.title": "タイトル",
  "dialog.task.title.placeholder": "例: 週次の依存関係レビュー",
  "dialog.task.prompt": "プロンプト",
  "dialog.task.prompt.placeholder": "各実行でエージェントに何をさせますか？",
  "dialog.task.cron": "スケジュール",
  "dialog.task.cron.expression": "cron 式",
  "dialog.task.cron.preset.hourly": "毎時",
  "dialog.task.cron.preset.daily": "毎日",
  "dialog.task.cron.preset.weekly": "毎週",
  "dialog.task.cron.preset.monthly": "毎月",
  "dialog.task.cron.preset.custom": "カスタム",
  ...
  "settings.general.row.messageWidth.title": "メッセージの幅",
  "settings.general.row.messageWidth.description": "チャットでユーザーメッセージをどの程度の幅まで広げられるかを設定します",
  "settings.general.row.messageWidth.option.default": "デフォルト",
  "settings.general.row.messageWidth.option.wide": "広い",
  ...
  "settings.general.row.messageAlign.option.center": "中央",
  "settings.general.row.messageAlign.option.right": "右",
  "settings.general.row.messageBorder.title": "メッセージの枠線",
  "settings.general.row.messageBorder.description": "ユーザーメッセージの枠線の色と太さを設定",
  "settings.general.row.messageBorder.width.none": "なし",
  "settings.general.row.messageBackground.title": "メッセージの背景",
  "settings.general.row.messageBackground.description": "ユーザーメッセージの背景色を設定",
  "settings.general.row.userMessageFont.title": "ユーザーメッセージの文字色",
  "settings.general.row.userMessageFont.description": "ユーザーメッセージの文字色を設定",
  ...
  "settings.general.row.fontWeight.extraLight": "極細",
  "settings.general.row.fontWeight.light": "ライト",
  "settings.general.row.fontWeight.regular": "レギュラー",
  ...
  "settings.providers.section.routing": "モデルルーティング",
  "settings.providers.routing.title": "ルーティング戦略",
  "settings.providers.routing.description": "OpenRouter が各リクエストでバックエンドプロバイダーを選択する方法。",
  "settings.providers.routing.price": "最安値",
  "settings.providers.routing.throughput": "最高スループット",
  ...
  "settings.plugins.plugins.add.browse": "参照…",
  ...
  "settings.plugins.skills.directories.title": "スキルディレクトリ",
  "settings.plugins.skills.directories.hint":
    "ディレクトリをオフにすると、そのスキルは検出対象から除外されます。ファイルはディスクに残ります。",
  "settings.plugins.skills.directories.toggle": "スキルディレクトリ {{directory}} を切り替え",
  "settings.plugins.skills.directories.disabled": "オフ",
  "settings.plugins.skills.directories.toggle.failed": "スキルディレクトリの更新に失敗しました",
