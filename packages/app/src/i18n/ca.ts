export const dict = {
  ...
  "command.session.search": "Cerca missatges",
  "command.session.search.description": "Cerca els missatges d'aquesta sessió",
  ...
  "dialog.search.empty": "No hi ha missatges coincidents",
  ...
  "settings.general.row.messageWidth.title": "Ample dels missatges",
  "settings.general.row.messageWidth.description": "Defineix l'ample màxim dels missatges de l'usuari a la conversa",
  "settings.general.row.messageWidth.option.default": "Predeterminat",
  "settings.general.row.messageWidth.option.wide": "Ample",
  ...
  "settings.general.row.messageAlign.option.center": "Centre",
  "settings.general.row.messageAlign.option.right": "Dreta",
  "settings.general.row.messageBorder.title": "Vora dels missatges",
  "settings.general.row.messageBorder.description": "Defineix el color i el gruix de la vora dels missatges de l'usuari",
  "settings.general.row.messageBorder.width.none": "Cap",
  "settings.general.row.messageBackground.title": "Fons dels missatges",
  "settings.general.row.messageBackground.description": "Defineix el color de fons dels missatges de l'usuari",
  "settings.general.row.userMessageFont.title": "Color del text dels missatges de l'usuari",
  "settings.general.row.userMessageFont.description": "Defineix el color del text dels missatges de l'usuari",
  ...
  "settings.providers.section.routing": "Enrutament de models",
  "settings.providers.routing.title": "Estratègia d'enrutament",
  "settings.providers.routing.description": "Com OpenRouter selecciona el proveïdor subjacent per a cada sol·licitud.",
  "settings.providers.routing.price": "Preu més baix",
  "settings.providers.routing.throughput": "Rendiment més alt",
  "settings.providers.routing.latency": "Latència més baixa",
  ...
  "settings.plugins.plugins.add.browse": "Explora…",
  ...
  "settings.plugins.skills.directories.title": "Directoris de skills",
  "settings.plugins.skills.directories.hint":
    "Desactiva un directori per excloure les seves skills del descobriment. Els fitxers es conserven al disc.",
  "settings.plugins.skills.directories.toggle": "Commuta el directori de skills {{directory}}",
  "settings.plugins.skills.directories.disabled": "Desactivat",
  "settings.plugins.skills.directories.toggle.failed": "No s'han pogut actualitzar els directoris de skills",
  ...
  "settings.plugins.plugins.count.many": "{{count}} de connectors",
  "settings.plugins.skills.count.many": "{{count}} d'habilitats",
