export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Color del text dels missatges de l'usuari",
  "settings.general.row.userMessageTextColor.description": "Defineix el color del text dels missatges de l'usuari",
