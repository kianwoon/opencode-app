export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Боја на текстот на пораките на корисникот",
  "settings.general.row.userMessageTextColor.description": "Поставете боја на текстот на пораките на корисникот",
