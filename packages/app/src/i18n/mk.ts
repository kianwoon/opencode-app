export const dict = {
  ...
  "command.session.search": "Пребарај пораки",
  "command.session.search.description": "Пребарувајте пораки во оваа сесија",
  ...
  "dialog.search.empty": "Нема соодветни пораки",
  ...
  "sidebar.drop.title": "Повлечете папка овде за да додадете проект",
  "sidebar.drop.foldersOnly": "Како проекти можат да се додадат само папки",
  ...
  "settings.general.row.messageWidth.title": "Ширина на порака",
  "settings.general.row.messageWidth.description": "Поставете колку широки може да бидат корисничките пораки во преписката",
  "settings.general.row.messageWidth.option.default": "Стандардно",
  "settings.general.row.messageWidth.option.wide": "Широко",
  ...
  "settings.general.row.messageAlign.option.center": "Центрирано",
  "settings.general.row.messageAlign.option.right": "Десно",
  "settings.general.row.messageBorder.title": "Раб на пораките",
  "settings.general.row.messageBorder.description": "Поставете боја и дебелина на рабтот околу пораките на корисникот",
  "settings.general.row.messageBorder.width.none": "Нема",
  "settings.general.row.messageBackground.title": "Позадина на пораките",
  "settings.general.row.messageBackground.description": "Поставете боја на позадината на пораките на корисникот",
  "settings.general.row.userMessageFont.title": "Боја на текстот на пораките на корисникот",
  "settings.general.row.userMessageFont.description": "Поставете боја на текстот на пораките на корисникот",
  ...
  "settings.providers.section.routing": "Насочување на модели",
  "settings.providers.routing.title": "Стратегија за насочување",
  "settings.providers.routing.description": "Како OpenRouter избира заднински услужник за секое барање.",
  "settings.providers.routing.price": "Најниска цена",
  "settings.providers.routing.throughput": "Најголем проток",
  "settings.providers.routing.latency": "Најниска латентност",
  ...
  "settings.plugins.plugins.add.browse": "Разгледај…",
  ...
  "settings.plugins.skills.directories.title": "Папки со вештини",
  "settings.plugins.skills.directories.hint":
    "Исклучувањето на папка ги исклучува нејзините вештини од откривањето. Датотеките остануваат на дискот.",
  "settings.plugins.skills.directories.toggle": "Преклопи папка со вештини {{directory}}",
  "settings.plugins.skills.directories.disabled": "Исклучено",
  "settings.plugins.skills.directories.toggle.failed": "Не успеа ажурирањето на папките со вештини",
