export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Foydalanuvchi xabari matnining rangi",
  "settings.general.row.userMessageTextColor.description": "Foydalanuvchi xabarlari matnining rangini belgilang",
