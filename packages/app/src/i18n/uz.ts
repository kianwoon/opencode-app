export const dict = {
  ...
  "command.session.search": "Xabarlarni qidirish",
  "command.session.search.description": "Ushbu seansdagi xabarlarni qidiring",
  ...
  "dialog.search.empty": "Mos keladigan xabarlar yo'q",
  ...
  "settings.general.row.messageWidth.title": "Xabar kengligi",
  "settings.general.row.messageWidth.description": "Foydalanuvchi xabarlari suhbatda qanchalik keng bo'lishi mumkinligini belgilang",
  "settings.general.row.messageWidth.option.default": "Standart",
  "settings.general.row.messageWidth.option.wide": "Keng",
  ...
  "settings.general.row.messageAlign.option.center": "Markazda",
  "settings.general.row.messageAlign.option.right": "O'ng",
  "settings.general.row.messageBorder.title": "Xabar ramkasi",
  "settings.general.row.messageBorder.description": "Foydalanuvchi xabarlari ramkasining rangi va qalinligini belgilang",
  "settings.general.row.messageBorder.width.none": "Yo'q",
  "settings.general.row.messageBackground.title": "Xabar foni",
  "settings.general.row.messageBackground.description": "Foydalanuvchi xabarlari fonining rangini belgilang",
  "settings.general.row.userMessageFont.title": "Foydalanuvchi xabari matnining rangi",
  "settings.general.row.userMessageFont.description": "Foydalanuvchi xabarlari matnining rangini belgilang",
  ...
  "settings.providers.section.routing": "Model marshrutlash",
  "settings.providers.routing.title": "Marshrutlash strategiyasi",
  "settings.providers.routing.description": "OpenRouter har bir so‘rov uchun orqa provayderni qanday tanlaydi.",
  "settings.providers.routing.price": "Eng arzon narx",
  "settings.providers.routing.throughput": "Eng yuqori o‘tkazish qobiliyati",
  ...
  "settings.plugins.skills.directories.title": "Ko'nikmalar papkalari",
  "settings.plugins.skills.directories.hint":
    "Papkani o'chirish uning ko'nikmalarini aniqlashdan chiqarib tashlaydi. Fayllar diskda qoladi.",
  "settings.plugins.skills.directories.toggle": "{{directory}} ko'nikmalar papkasini almashtirish",
  "settings.plugins.skills.directories.disabled": "O'chirilgan",
  "settings.plugins.skills.directories.toggle.failed": "Ko'nikmalar papkalarini yangilash muvaffaqiyatsiz tugadi",
