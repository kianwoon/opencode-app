export const dict = {
  ...
  "command.session.search": "Cari mesej",
  "command.session.search.description": "Cari mesej dalam sesi ini",
  ...
  "dialog.search.empty": "Tiada mesej padan",
  ...
  "sidebar.drop.title": "Tarik folder ke sini untuk menambah projek",
  "sidebar.drop.foldersOnly": "Hanya folder boleh ditambah sebagai projek",
  ...
  "settings.general.row.messageWidth.title": "Lebar mesej",
  "settings.general.row.messageWidth.description": "Tetapkan seberapa lebar mesej pengguna boleh dalam transkrip",
  "settings.general.row.messageWidth.option.default": "Lalai",
  "settings.general.row.messageWidth.option.wide": "Lebar",
  ...
  "settings.general.row.messageAlign.option.center": "Tengah",
  "settings.general.row.messageAlign.option.right": "Kanan",
  "settings.general.row.messageBorder.title": "Bingkai mesej",
  "settings.general.row.messageBorder.description": "Tetapkan warna dan ketebalan bingkai sekitar mesej pengguna",
  "settings.general.row.messageBorder.width.none": "Tiada",
  "settings.general.row.messageBackground.title": "Latar mesej",
  "settings.general.row.messageBackground.description": "Tetapkan warna latar mesej pengguna",
  "settings.general.row.userMessageFont.title": "Warna teks mesej pengguna",
  "settings.general.row.userMessageFont.description": "Tetapkan warna teks mesej pengguna",
  ...
  "settings.providers.section.routing": "Perutean model",
  "settings.providers.routing.title": "Strategi perutean",
  "settings.providers.routing.description": "Bagaimana OpenRouter memilih penyedia sandaran untuk setiap permintaan.",
  "settings.providers.routing.price": "Harga terendah",
  "settings.providers.routing.throughput": "Nilai pemprosesan tertinggi",
  ...
  "settings.plugins.plugins.add.browse": "Layar…",
  ...
  "settings.plugins.skills.directories.title": "Direktori kemahiran",
  "settings.plugins.skills.directories.hint":
    "Matikan direktori untuk mengecualikan kemahirannya daripada pengesanan. Fail dikekalkan pada cakera.",
  "settings.plugins.skills.directories.toggle": "Togol direktori kemahiran {{directory}}",
  "settings.plugins.skills.directories.disabled": "Mati",
  "settings.plugins.skills.directories.toggle.failed": "Gagal mengemas kini direktori kemahiran",
