export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Warna teks mesej pengguna",
  "settings.general.row.userMessageTextColor.description": "Tetapkan warna teks mesej pengguna",
