export const dict = {
  ...
  "command.session.search": "Leita eftir boðum",
  "command.session.search.description": "Leita eftir boðunum í hesi setuni",
  ...
  "dialog.search.empty": "Eingi samsvarandi boð",
  ...
  "settings.general.row.messageWidth.title": "Boðbreidd",
  "settings.general.row.messageWidth.description": "Vel hvussu breið brúkarabodskapur má vera í samrøðuni",
  "settings.general.row.messageWidth.option.default": "Sjálvsett",
  ...
  "settings.general.row.messageAlign.option.right": "Høgru",
  "settings.general.row.messageBorder.title": "Boðramma",
  "settings.general.row.messageBorder.description": "Set lit og tjukkna á rammuna rundum boðini frá brúkara",
  "settings.general.row.messageBorder.width.none": "Eingin",
  "settings.general.row.messageBackground.title": "Boðbakgrund",
  "settings.general.row.messageBackground.description": "Set bakgrundslitið á boðini frá brúkara",
  "settings.general.row.userMessageFont.title": "Tekstlitur á boðini frá brúkara",
  "settings.general.row.userMessageFont.description": "Set tekstlitin á boðini frá brúkara",
  ...
  "settings.general.row.fontWeight.extraLight": "Extra ljósur",
  "settings.general.row.fontWeight.light": "Ljósur",
  "settings.general.row.fontWeight.regular": "Vanligur",
  ...
  "settings.providers.routing.title": "Routing-strategi",
  "settings.providers.routing.description": "Hvussu OpenRouter velur bakgrundsinnevaraðaran fyri hvørja fyrispurning.",
  "settings.providers.routing.price": "Lægsta prísur",
  "settings.providers.routing.throughput": "Hægsta gegnumstreym",
