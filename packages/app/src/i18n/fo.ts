export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Tekstlitur á boðini frá brúkara",
  "settings.general.row.userMessageTextColor.description": "Set tekstlitin á boðini frá brúkara",
