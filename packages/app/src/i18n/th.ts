export const dict = {
  ...
  "sidebar.tasks.title": "งาน",
  "sidebar.tasks.new": "งานใหม่",
  "sidebar.tasks.loading": "กำลังโหลดงาน...",
  "sidebar.tasks.empty": "ไม่มีงานที่กำหนดเวลาไว้",
  "sidebar.tasks.pause": "หยุดงานชั่วคราว",
  "sidebar.tasks.resume": "ดำเนินงานต่อ",
  "sidebar.tasks.runNow": "เรียกใช้เดี๋ยวนี้",
  "dialog.task.new.title": "งานใหม่",
  "dialog.task.title": "ชื่อ",
  "dialog.task.title.placeholder": "เช่น ตรวจสอบข้อกำหนดรายสัปดาห์",
  "dialog.task.prompt": "พรอมป์",
  "dialog.task.prompt.placeholder": "ต้องการให้เอเจนต์ทำอะไรในแต่ละรอบการรัน?",
  "dialog.task.cron": "กำหนดเวลา",
  "dialog.task.cron.expression": "นิพจน์ cron",
  "dialog.task.cron.preset.hourly": "ทุกชั่วโมง",
  "dialog.task.cron.preset.daily": "ทุกวัน",
  "dialog.task.cron.preset.weekly": "ทุกสัปดาห์",
  "dialog.task.cron.preset.monthly": "ทุกเดือน",
  "dialog.task.cron.preset.custom": "กำหนดเอง",
  ...
  "settings.general.row.messageWidth.title": "ความกว้างของข้อความ",
  "settings.general.row.messageWidth.description": "กำหนดว่าข้อความของผู้ใช้จะกว้างได้มากแค่ไหนในบทสนทนา",
  "settings.general.row.messageWidth.option.default": "ค่าเริ่มต้น",
  "settings.general.row.messageWidth.option.wide": "กว้าง",
  ...
  "settings.general.row.messageAlign.option.center": "กึ่งกลาง",
  "settings.general.row.messageAlign.option.right": "ขวา",
  "settings.general.row.messageBorder.title": "เส้นขอบข้อความ",
  "settings.general.row.messageBorder.description": "ตั้งค่าสีและความหนาของเส้นขอบรอบข้อความของผู้ใช้",
  "settings.general.row.messageBorder.width.none": "ไม่มี",
  "settings.general.row.messageBackground.title": "พื้นหลังข้อความ",
  "settings.general.row.messageBackground.description": "ตั้งค่าสีพื้นหลังของข้อความของผู้ใช้",
  "settings.general.row.userMessageFont.title": "สีข้อความของผู้ใช้",
  "settings.general.row.userMessageFont.description": "ตั้งค่าสีข้อความของผู้ใช้",
  ...
  "settings.general.row.fontWeight.extraLight": "พิเศษบาง",
  "settings.general.row.fontWeight.light": "บาง",
  "settings.general.row.fontWeight.regular": "ปกติ",
  ...
  "settings.providers.section.routing": "การกำหนดเส้นทางโมเดล",
  "settings.providers.routing.title": "กลยุทธ์การกำหนดเส้นทาง",
  "settings.providers.routing.description": "OpenRouter เลือกผู้ให้บริการแบ็กเอนด์สำหรับคำขอแต่ละรายการอย่างไร",
  "settings.providers.routing.price": "ราคาต่ำสุด",
  "settings.providers.routing.throughput": "ความเร็วสูงสุด",
  ...
  "settings.plugins.plugins.add.browse": "เรียกดู…",
  ...
  "settings.plugins.skills.directories.title": "โฟลเดอร์ทักษะ",
  "settings.plugins.skills.directories.hint": "ปิดโฟลเดอร์จะไม่รวมทักษะในนั้นไว้ในการค้นหา ไฟล์ยังคงอยู่บนดิสก์",
  "settings.plugins.skills.directories.toggle": "สลับโฟลเดอร์ทักษะ {{directory}}",
  "settings.plugins.skills.directories.disabled": "ปิด",
  "settings.plugins.skills.directories.toggle.failed": "อัปเดตโฟลเดอร์ทักษะไม่สำเร็จ",
