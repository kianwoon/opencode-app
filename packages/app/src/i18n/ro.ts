export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Culoarea textului mesajelor utilizatorului",
  "settings.general.row.userMessageTextColor.description": "Stabiliți culoarea textului mesajelor utilizatorului",
