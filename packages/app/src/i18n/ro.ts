export const dict = {
  ...
  "command.session.search": "Caută mesaje",
  "command.session.search.description": "Caută mesajele din această sesiune",
  ...
  "dialog.search.empty": "Niciun mesaj corespunzător",
  ...
  "settings.general.row.messageWidth.title": "Lățimea mesajelor",
  "settings.general.row.messageWidth.description": "Setați cât de late pot fi mesajele utilizatorului în conversație",
  "settings.general.row.messageWidth.option.default": "Implicit",
  "settings.general.row.messageWidth.option.wide": "Late",
  ...
  "settings.general.row.messageAlign.option.center": "Centrat",
  "settings.general.row.messageAlign.option.right": "Dreapta",
  "settings.general.row.messageBorder.title": "Chenarul mesajelor",
  "settings.general.row.messageBorder.description": "Stabiliți culoarea și grosimea chenarului mesajelor utilizatorului",
  "settings.general.row.messageBorder.width.none": "Fără",
  "settings.general.row.messageBackground.title": "Fundalul mesajelor",
  "settings.general.row.messageBackground.description": "Stabiliți culoarea de fundal a mesajelor utilizatorului",
  "settings.general.row.userMessageFont.title": "Culoarea textului mesajelor utilizatorului",
  "settings.general.row.userMessageFont.description": "Stabiliți culoarea textului mesajelor utilizatorului",
  ...
  "settings.providers.section.routing": "Rutarea modelelor",
  "settings.providers.routing.title": "Strategie de rutare",
  "settings.providers.routing.description": "Cum selectează OpenRouter furnizorul de rezervă pentru fiecare cerere.",
  "settings.providers.routing.price": "Cel mai mic preț",
  "settings.providers.routing.throughput": "Cel mai mare debit",
  "settings.providers.routing.latency": "Cea mai mică latență",
  ...
  "settings.plugins.plugins.add.browse": "Răsfoiește…",
  ...
  "settings.plugins.skills.directories.title": "Foldere de abilități",
  "settings.plugins.skills.directories.hint":
    "Dezactivarea unui folder exclude abilitățile acestuia din descoperire. Fișierele rămân pe disc.",
  "settings.plugins.skills.directories.toggle": "Comută folderul de abilități {{directory}}",
  "settings.plugins.skills.directories.disabled": "Dezactivat",
  "settings.plugins.skills.directories.toggle.failed": "Actualizarea folderelor de abilități a eșuat",
  ...
  "settings.plugins.plugins.count.few": "{{count}} pluginuri",
  "settings.plugins.skills.count.few": "{{count}} abilități",
