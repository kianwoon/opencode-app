export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "لون نص رسائل المستخدم",
  "settings.general.row.userMessageTextColor.description": "تعيين لون نص رسائل المستخدم",
