export const dict = {
  ...
  "command.session.search": "البحث في الرسائل",
  "command.session.search.description": "البحث في رسائل هذه الجلسة",
  ...
  "dialog.search.empty": "لا توجد رسائل مطابقة",
  ...
  "sidebar.tasks.title": "المهام",
  "sidebar.tasks.new": "مهمة جديدة",
  "sidebar.tasks.loading": "جارٍ تحميل المهام...",
  "sidebar.tasks.empty": "لا توجد مهام مجدولة",
  "sidebar.tasks.pause": "إيقاف المهمة مؤقتًا",
  "sidebar.tasks.resume": "استئناف المهمة",
  "sidebar.tasks.runNow": "تشغيل الآن",
  "dialog.task.new.title": "مهمة جديدة",
  "dialog.task.title": "العنوان",
  "dialog.task.title.placeholder": "مثال: مراجعة التبعيات الأسبوعية",
  "dialog.task.prompt": "الطلب",
  "dialog.task.prompt.placeholder": "ماذا يجب أن يفعل الوكيل في كل تشغيل؟",
  "dialog.task.cron": "الجدول",
  "dialog.task.cron.expression": "تعبير cron",
  "dialog.task.cron.preset.hourly": "كل ساعة",
  "dialog.task.cron.preset.daily": "يوميًا",
  "dialog.task.cron.preset.weekly": "أسبوعيًا",
  "dialog.task.cron.preset.monthly": "شهريًا",
  "dialog.task.cron.preset.custom": "مخصص",
  ...
  "settings.general.row.messageWidth.title": "عرض الرسالة",
  "settings.general.row.messageWidth.description": "حدّد مدى عرض رسائل المستخدم في سجل المحادثة",
  "settings.general.row.messageWidth.option.default": "افتراضي",
  "settings.general.row.messageWidth.option.wide": "عريض",
  ...
  "settings.general.row.messageAlign.option.center": "وسط",
  "settings.general.row.messageAlign.option.right": "يمين",
  "settings.general.row.messageBorder.title": "إطار الرسائل",
  "settings.general.row.messageBorder.description": "تعيين لون إطار الرسائل وسماكته",
  "settings.general.row.messageBorder.width.none": "بلا",
  "settings.general.row.messageBackground.title": "خلفية الرسائل",
  "settings.general.row.messageBackground.description": "تعيين لون خلفية رسائل المستخدم",
  "settings.general.row.userMessageFont.title": "لون نص رسائل المستخدم",
  "settings.general.row.userMessageFont.description": "تعيين لون نص رسائل المستخدم",
  ...
  "settings.general.row.fontWeight.extraLight": "خفيف جداً",
  "settings.general.row.fontWeight.light": "خفيف",
  "settings.general.row.fontWeight.regular": "عادي",
  ...
  "settings.providers.section.routing": "توجيه النماذج",
  "settings.providers.routing.title": "استراتيجية التوجيه",
  "settings.providers.routing.description": "كيف يختار OpenRouter مزوّد الخدمة الخلفي لكل طلب.",
  ...
  "settings.plugins.plugins.add.browse": "استعراض…",
  ...
  "settings.plugins.skills.directories.title": "مجلدات المهارات",
  "settings.plugins.skills.directories.hint":
    "يؤدي إيقاف تشغيل مجلد إلى استبعاد مهاراته من الاكتشاف. تظل الملفات محفوظة على القرص.",
  "settings.plugins.skills.directories.toggle": "تبديل مجلد المهارات {{directory}}",
  "settings.plugins.skills.directories.disabled": "إيقاف",
  "settings.plugins.skills.directories.toggle.failed": "فشل تحديث مجلدات المهارات",
  ...
  "settings.plugins.plugins.count.zero": "عدد الإضافات: {{count}}",
  "settings.plugins.plugins.count.two": "إضافتان ({{count}})",
  "settings.plugins.plugins.count.few": "{{count}} إضافات",
  "settings.plugins.plugins.count.many": "{{count}} إضافة",
  "settings.plugins.skills.count.zero": "عدد المهارات: {{count}}",
  "settings.plugins.skills.count.two": "مهارتان ({{count}})",
  "settings.plugins.skills.count.few": "{{count}} مهارات",
  "settings.plugins.skills.count.many": "{{count}} مهارة",
