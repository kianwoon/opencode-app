...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Kullanıcı mesajı metin rengi",
  "settings.general.row.userMessageTextColor.description": "Kullanıcı mesajlarının metin rengini ayarlayın",
