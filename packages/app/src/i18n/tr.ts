...
export const dict = {
  ...
  "sidebar.tasks.title": "Görevler",
  "sidebar.tasks.new": "Yeni görev",
  "sidebar.tasks.loading": "Görevler yükleniyor...",
  "sidebar.tasks.empty": "Zamanlanmış görev yok",
  "sidebar.tasks.pause": "Görevi duraklat",
  "sidebar.tasks.resume": "Görevi sürdür",
  "sidebar.tasks.runNow": "Şimdi çalıştır",
  "dialog.task.new.title": "Yeni görev",
  "dialog.task.title": "Başlık",
  "dialog.task.title.placeholder": "ör. Haftalık bağımlılık incelemesi",
  "dialog.task.prompt": "İstem",
  "dialog.task.prompt.placeholder": "Her çalıştırmada ajan ne yapmalı?",
  "dialog.task.cron": "Zamanlama",
  "dialog.task.cron.expression": "Cron ifadesi",
  "dialog.task.cron.preset.hourly": "Saatlik",
  "dialog.task.cron.preset.daily": "Günlük",
  "dialog.task.cron.preset.weekly": "Haftalık",
  "dialog.task.cron.preset.monthly": "Aylık",
  "dialog.task.cron.preset.custom": "Özel",
  ...
  "settings.general.row.messageWidth.title": "Mesaj genişliği",
  "settings.general.row.messageWidth.description": "Kullanıcı mesajlarının sohbette ne kadar geniş olabileceğini ayarlayın",
  "settings.general.row.messageWidth.option.default": "Varsayılan",
  "settings.general.row.messageWidth.option.wide": "Geniş",
  ...
  "settings.general.row.messageAlign.option.center": "Orta",
  "settings.general.row.messageAlign.option.right": "Sağ",
  "settings.general.row.messageBorder.title": "Mesaj kenarlığı",
  "settings.general.row.messageBorder.description": "Kullanıcı mesajlarının kenarlık rengini ve kalınlığını ayarlayın",
  "settings.general.row.messageBorder.width.none": "Yok",
  "settings.general.row.messageBackground.title": "Mesaj arka planı",
  "settings.general.row.messageBackground.description": "Kullanıcı mesajlarının arka plan rengini ayarlayın",
  "settings.general.row.userMessageFont.title": "Kullanıcı mesajı metin rengi",
  "settings.general.row.userMessageFont.description": "Kullanıcı mesajlarının metin rengini ayarlayın",
  ...
  "settings.providers.section.routing": "Model yönlendirme",
  "settings.providers.routing.title": "Yönlendirme stratejisi",
  "settings.providers.routing.description": "OpenRouter her istek için arka uç sağlayıcıyı nasıl seçer.",
  "settings.providers.routing.price": "En düşük fiyat",
  "settings.providers.routing.throughput": "En yüksek verimlilik",
  ...
  "settings.plugins.plugins.add.browse": "Gözat…",
  ...
  "settings.plugins.skills.directories.title": "Beceri dizinleri",
  "settings.plugins.skills.directories.hint":
    "Bir dizini kapatmak, becerilerini keşfetmenin dışında tutar. Dosyalar diskte kalır.",
  "settings.plugins.skills.directories.toggle": "{{directory}} beceri dizinini aç/kapat",
  "settings.plugins.skills.directories.disabled": "Kapalı",
  "settings.plugins.skills.directories.toggle.failed": "Beceri dizinleri güncellenemedi",
