export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Lietotāja ziņu teksta krāsa",
  "settings.general.row.userMessageTextColor.description": "Norādiet lietotāja ziņu teksta krāsu",
