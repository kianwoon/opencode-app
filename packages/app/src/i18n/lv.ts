export const dict = {
  ...
  "command.session.search": "Meklēt ziņojumus",
  "command.session.search.description": "Meklēt ziņojumus šajā sesijā",
  ...
  "dialog.search.empty": "Nav atbilstošu ziņojumu",
  ...
  "settings.general.row.messageWidth.title": "Ziņojuma platums",
  "settings.general.row.messageWidth.description": "Norādiet, cik plati lietotāja ziņojumi var būt sarunā",
  "settings.general.row.messageWidth.option.default": "Noklusējums",
  "settings.general.row.messageWidth.option.wide": "Plašs",
  ...
  "settings.general.row.messageAlign.option.center": "Centrā",
  "settings.general.row.messageAlign.option.right": "Pa labi",
  "settings.general.row.messageBorder.title": "Ziņu rāmis",
  "settings.general.row.messageBorder.description": "Norādiet lietotāja ziņu rāmja krāsu un biezumu",
  "settings.general.row.messageBorder.width.none": "Nav",
  "settings.general.row.messageBackground.title": "Ziņu fons",
  "settings.general.row.messageBackground.description": "Norādiet lietotāja ziņu fona krāsu",
  "settings.general.row.userMessageFont.title": "Lietotāja ziņu teksta krāsa",
  "settings.general.row.userMessageFont.description": "Norādiet lietotāja ziņu teksta krāsu",
  ...
  "settings.general.row.fontWeight.extraLight": "Īpaši gaišs",
  "settings.general.row.fontWeight.light": "Gaišs",
  "settings.general.row.fontWeight.regular": "Parasts",
  ...
  "settings.providers.section.routing": "Modeļu maršrutēšana",
  "settings.providers.routing.title": "Maršrutēšanas stratēģija",
  "settings.providers.routing.description":
    "Kā OpenRouter izvēlas aizmugures pakalpojumu sniedzēju katram pieprasījumam.",
  "settings.providers.routing.price": "Zemākā cena",
  "settings.providers.routing.throughput": "Lielākā caurlaidspēja",
  ...
  "settings.plugins.plugins.add.browse": "Pārlūkot…",
  ...
  "settings.plugins.skills.directories.title": "Prasmju katalogi",
  "settings.plugins.skills.directories.hint":
    "Kataloga izslēgšana izslēdz tā prasmes no atklāšanas. Faili paliek diskā.",
  "settings.plugins.skills.directories.toggle": "Pārslēgt prasmju katalogu {{directory}}",
  "settings.plugins.skills.directories.disabled": "Izslēgts",
  "settings.plugins.skills.directories.toggle.failed": "Neizdevās atjaunināt prasmju katalogus",
  ...
  "settings.plugins.plugins.count.zero": "{{count}} spraudņu",
  "settings.plugins.skills.count.zero": "{{count}} prasmju",
