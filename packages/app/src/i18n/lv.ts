export const dict = {
  ...
  "settings.providers.routing.description": "Kā OpenRouter izvēlas aizmugures pakalpojumu sniedzēju katram pieprasījumam.",
  ...
  "settings.plugins.skills.directories.hint": "Kataloga izslēgšana izslēdz tā prasmes no atklāšanas. Faili paliek diskā.",
