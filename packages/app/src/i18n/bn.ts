export const dict: Record<string, string> = {
  ...
  "settings.general.row.userMessageTextColor.title": "ব্যবহারকারীর বার্তার পাঠ্যের রঙ",
  "settings.general.row.userMessageTextColor.description": "ব্যবহারকারীর বার্তার পাঠ্যের রঙ নির্ধারণ করুন",
