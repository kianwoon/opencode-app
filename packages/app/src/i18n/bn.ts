export const dict: Record<string, string> = {
  ...
  "command.session.search": "বার্তা অনুসন্ধান করুন",
  "command.session.search.description": "এই সেশনের বার্তাগুলি অনুসন্ধান করুন",
  ...
  "dialog.search.empty": "কোনো মিলে যাওয়া বার্তা নেই",
  ...
  "settings.general.row.messageWidth.title": "বার্তার প্রস্থ",
  "settings.general.row.messageWidth.description": "ট্রান্সক্রিপ্টে ব্যবহারকারীর বার্তা কতটা চওড়া হতে পারে তা নির্ধারণ করুন",
  "settings.general.row.messageWidth.option.default": "ডিফল্ট",
  "settings.general.row.messageWidth.option.wide": "চওড়া",
  ...
  "settings.general.row.messageAlign.option.center": "মাঝ",
  "settings.general.row.messageAlign.option.right": "ডান",
  "settings.general.row.messageBorder.title": "বার্তার সীমানা",
  "settings.general.row.messageBorder.description": "ব্যবহারকারীর বার্তার সীমানার রঙ ও বেধ নির্ধারণ করুন",
  "settings.general.row.messageBorder.width.none": "নেই",
  "settings.general.row.messageBackground.title": "বার্তার পটভূমি",
  "settings.general.row.messageBackground.description": "ব্যবহারকারীর বার্তার পটভূমির রঙ নির্ধারণ করুন",
  "settings.general.row.userMessageFont.title": "ব্যবহারকারীর বার্তার পাঠ্যের রঙ",
  "settings.general.row.userMessageFont.description": "ব্যবহারকারীর বার্তার পাঠ্যের রঙ নির্ধারণ করুন",
  ...
  "settings.general.row.fontWeight.extraLight": "অতি হালকা",
  "settings.general.row.fontWeight.light": "হালকা",
  "settings.general.row.fontWeight.regular": "নিয়মিত",
  ...
  "settings.providers.section.routing": "মডেল রাউটিং",
  "settings.providers.routing.title": "রাউটিং কৌশল",
  "settings.providers.routing.description": "প্রতিটি অনুরোধের জন্য OpenRouter কীভাবে ব্যাকিং প্রোভাইডার বাছাই করে।",
