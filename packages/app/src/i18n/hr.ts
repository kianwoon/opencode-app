...
export const dict = {
  ...
  "sidebar.tasks.title": "Tasks",
  "sidebar.tasks.new": "New task",
  "sidebar.tasks.loading": "Loading tasks...",
  "sidebar.tasks.empty": "No scheduled tasks",
  "sidebar.tasks.pause": "Pause task",
  "sidebar.tasks.resume": "Resume task",
  "sidebar.tasks.runNow": "Run now",
  "dialog.task.new.title": "New task",
  "dialog.task.title": "Title",
  "dialog.task.title.placeholder": "e.g. Weekly dependency review",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "What should the agent do on each run?",
  "dialog.task.cron": "Schedule",
  "dialog.task.cron.expression": "Cron expression",
  "dialog.task.cron.preset.hourly": "Hourly",
  "dialog.task.cron.preset.daily": "Daily",
  "dialog.task.cron.preset.weekly": "Weekly",
  "dialog.task.cron.preset.monthly": "Monthly",
  "dialog.task.cron.preset.custom": "Custom",
  ...
  "settings.general.row.messageWidth.title": "Širina poruka",
  "settings.general.row.messageWidth.description": "Odredite koliko široko mogu biti korisničke poruke u prepisci",
  "settings.general.row.messageWidth.option.default": "Zadano",
  "settings.general.row.messageWidth.option.wide": "Široko",
  "settings.general.row.messageWidth.option.wider": "Šire",
  "settings.general.row.messageWidth.option.full": "Puno",
  "settings.general.row.messageWidth.option.max": "Maksimalno",
  "settings.general.row.messageWidth.option.maxPlus": "Max+",
  "settings.general.row.messageAlign.title": "Poravnanje poruka",
  "settings.general.row.messageAlign.description": "Postavite gdje se poruke korisnika poravnavaju u zapisu",
  "settings.general.row.messageAlign.option.left": "Lijevo",
  "settings.general.row.messageAlign.option.center": "Sredina",
  "settings.general.row.messageAlign.option.right": "Desno",
  "settings.general.row.messageBorder.title": "Obrub poruka",
  "settings.general.row.messageBorder.description": "Postavite boju i debljinu obruba oko poruka korisnika",
  "settings.general.row.messageBorder.width.none": "Bez",
  "settings.general.row.messageBackground.title": "Pozadina poruka",
  "settings.general.row.messageBackground.description": "Postavite boju pozadine poruka korisnika",
  "settings.general.row.userMessageFont.title": "Boja teksta poruka korisnika",
  "settings.general.row.userMessageFont.description": "Postavite boju teksta poruka korisnika",
  ...
  "settings.general.row.fontColor.help": "Boja: svijetla / tamna",
  ...
  "settings.providers.section.routing": "Usmjeravanje modela",
  "settings.providers.routing.title": "Strategija usmjeravanja",
  "settings.providers.routing.description": "Kako OpenRouter bira pozadinskog davatelja za svaki zahtjev.",
  "settings.providers.routing.price": "Najniža cijena",
  "settings.providers.routing.throughput": "Najveća propusnost",
  "settings.providers.routing.latency": "Najniža latencija",
  ...
  "settings.plugins.plugins.add.browse": "Potraži…",
  ...
  "settings.plugins.skills.directories.title": "Mape s vještinama",
  "settings.plugins.skills.directories.hint":
    "Isključivanjem mape isključujete njezine vještine iz otkrivanja. Datoteke ostaju na disku.",
  "settings.plugins.skills.directories.toggle": "Prebaci mapu vještina {{directory}}",
  "settings.plugins.skills.directories.disabled": "Isključeno",
  "settings.plugins.skills.directories.toggle.failed": "Ažuriranje mapa vještina nije uspjelo",
  ...
  "settings.plugins.plugins.count.few": "{{count}} dodatka",
  "settings.plugins.skills.count.few": "{{count}} vještine",
