...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Boja teksta poruka korisnika",
  "settings.general.row.userMessageTextColor.description": "Postavite boju teksta poruka korisnika",
