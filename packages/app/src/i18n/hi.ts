export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "उपयोगकर्ता संदेश पाठ का रंग",
  "settings.general.row.userMessageTextColor.description": "उपयोगकर्ता संदेशों के पाठ का रंग सेट करें",
