export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Couleur du texte des messages utilisateur",
  "settings.general.row.userMessageTextColor.description": "Définir la couleur du texte des messages utilisateur",
