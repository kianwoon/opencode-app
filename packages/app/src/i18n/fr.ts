export const dict = {
  ...
  "command.session.search": "Rechercher des messages",
  "command.session.search.description": "Rechercher les messages de cette session",
  ...
  "dialog.search.empty": "Aucun message correspondant",
  ...
  "sidebar.drop.title": "Déposez un dossier ici pour ajouter un projet",
  "sidebar.drop.foldersOnly": "Seuls les dossiers peuvent être ajoutés comme projets",

  "sidebar.tasks.title": "Tâches",
  "sidebar.tasks.new": "Nouvelle tâche",
  "sidebar.tasks.loading": "Chargement des tâches...",
  "sidebar.tasks.empty": "Aucune tâche planifiée",
  "sidebar.tasks.pause": "Suspendre la tâche",
  "sidebar.tasks.resume": "Reprendre la tâche",
  "sidebar.tasks.runNow": "Exécuter maintenant",
  "dialog.task.new.title": "Nouvelle tâche",
  "dialog.task.title": "Titre",
  "dialog.task.title.placeholder": "ex. Revue hebdomadaire des dépendances",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Que doit faire l'agent à chaque exécution ?",
  "dialog.task.cron": "Planification",
  "dialog.task.cron.expression": "Expression cron",
  "dialog.task.cron.preset.hourly": "Toutes les heures",
  "dialog.task.cron.preset.daily": "Tous les jours",
  "dialog.task.cron.preset.weekly": "Toutes les semaines",
  "dialog.task.cron.preset.monthly": "Tous les mois",
  "dialog.task.cron.preset.custom": "Personnalisé",
  ...
  "settings.general.row.messageWidth.title": "Largeur des messages",
  "settings.general.row.messageWidth.description": "Définissez la largeur maximale des messages utilisateur dans la conversation",
  "settings.general.row.messageWidth.option.default": "Par défaut",
  "settings.general.row.messageWidth.option.wide": "Large",
  ...
  "settings.general.row.messageAlign.option.center": "Centré",
  "settings.general.row.messageAlign.option.right": "Droite",
  "settings.general.row.messageBorder.title": "Bordure des messages",
  "settings.general.row.messageBorder.description": "Définir la couleur et l'épaisseur de la bordure des messages utilisateur",
  "settings.general.row.messageBorder.width.none": "Aucune",
  "settings.general.row.messageBackground.title": "Arrière-plan des messages",
  "settings.general.row.messageBackground.description": "Définir la couleur d'arrière-plan des messages utilisateur",
  "settings.general.row.userMessageFont.title": "Couleur du texte des messages utilisateur",
  "settings.general.row.userMessageFont.description": "Définir la couleur du texte des messages utilisateur",
  ...
  "settings.providers.section.routing": "Routage des modèles",
  "settings.providers.routing.title": "Stratégie de routage",
  "settings.providers.routing.description":
    "Comment OpenRouter sélectionne le fournisseur sous-jacent pour chaque requête.",
  "settings.providers.routing.price": "Prix le plus bas",
  "settings.providers.routing.throughput": "Débit le plus élevé",
  "settings.providers.routing.latency": "Latence la plus faible",
  ...
  "settings.plugins.plugins.add.browse": "Parcourir…",
  ...
  "settings.plugins.skills.directories.title": "Répertoires de skills",
  "settings.plugins.skills.directories.hint":
    "Désactivez un répertoire pour exclure ses skills de la découverte. Les fichiers restent sur le disque.",
  "settings.plugins.skills.directories.toggle": "Basculer le répertoire de skills {{directory}}",
  "settings.plugins.skills.directories.disabled": "Inactif",
  "settings.plugins.skills.directories.toggle.failed": "Échec de la mise à jour des répertoires de skills",
  ...
  "settings.plugins.plugins.count.many": "{{count}} de plugins",
  "settings.plugins.skills.count.many": "{{count}} de skills",
