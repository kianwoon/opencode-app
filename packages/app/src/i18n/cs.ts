export const dict = {
  ...
  "command.session.search": "Hledat zprávy",
  "command.session.search.description": "Hledat zprávy v této relaci",
  ...
  "dialog.search.empty": "Žádné odpovídající zprávy",
  ...
  "sidebar.tasks.title": "Úlohy",
  "sidebar.tasks.new": "Nová úloha",
  "sidebar.tasks.loading": "Načítají se úlohy...",
  "sidebar.tasks.empty": "Žádné naplánované úlohy",
  "sidebar.tasks.pause": "Pozastavit úlohu",
  "sidebar.tasks.resume": "Pokračovat v úloze",
  "sidebar.tasks.runNow": "Spustit nyní",
  "dialog.task.new.title": "Nová úloha",
  "dialog.task.title": "Název",
  "dialog.task.title.placeholder": "např. Týdenní kontrola závislostí",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Co má agent při každém spuštění dělat?",
  "dialog.task.cron": "Plán",
  "dialog.task.cron.expression": "Výraz cron",
  "dialog.task.cron.preset.hourly": "Každou hodinu",
  "dialog.task.cron.preset.daily": "Denně",
  "dialog.task.cron.preset.weekly": "Týdně",
  "dialog.task.cron.preset.monthly": "Měsíčně",
  "dialog.task.cron.preset.custom": "Vlastní",
  ...
  "settings.general.row.messageWidth.title": "Šířka zpráv",
  "settings.general.row.messageWidth.description": "Nastavte, jak široké mohou být zprávy uživatele v přepisu",
  "settings.general.row.messageWidth.option.default": "Výchozí",
  "settings.general.row.messageWidth.option.wide": "Široká",
  "settings.general.row.messageWidth.option.wider": "Širší",
  "settings.general.row.messageWidth.option.full": "Plná",
  "settings.general.row.messageWidth.option.max": "Maximální",
  "settings.general.row.messageWidth.option.maxPlus": "Max+",
  "settings.general.row.messageAlign.title": "Zarovnání zpráv",
  "settings.general.row.messageAlign.description": "Nastavte, kde se uživatelské zprávy v přepisu zarovnávají",
  "settings.general.row.messageAlign.option.left": "Vlevo",
  "settings.general.row.messageAlign.option.center": "Na střed",
  "settings.general.row.messageAlign.option.right": "Vpravo",
  "settings.general.row.messageBorder.title": "Ohraničení zpráv",
  "settings.general.row.messageBorder.description": "Nastavte barvu a tloušťku ohraničení uživatelských zpráv",
  "settings.general.row.messageBorder.width.none": "Žádné",
  "settings.general.row.messageBackground.title": "Pozadí zpráv",
  "settings.general.row.messageBackground.description": "Nastavte barvu pozadí uživatelských zpráv",
  "settings.general.row.userMessageFont.title": "Barva textu zpráv uživatele",
  "settings.general.row.userMessageFont.description": "Nastavte barvu textu uživatelských zpráv",
  ...
  "settings.general.row.fontWeight.extraLight": "Extra světlý",
  "settings.general.row.fontWeight.light": "Světlý",
  "settings.general.row.fontWeight.regular": "Obyčejné",
  "settings.general.row.fontWeight.medium": "Střední",
  "settings.general.row.fontWeight.semibold": "Polotučné",
  "settings.general.row.fontWeight.bold": "Tučné",
  "settings.general.row.fontColor.help": "Barva: světlá / tmavá",
  ...
  "settings.orchestration.row.model.title": "Brain model",
  "settings.orchestration.row.model.description": "Primary agent model in the format provider/model",
  "settings.orchestration.row.model.placeholder": "provider/model",
  "settings.orchestration.row.handsModel.title": "Hands model",
  "settings.orchestration.row.handsModel.description": "Model for explorer and implementer agents in the format provider/model",
  "settings.orchestration.row.handsModel.placeholder": "provider/model",
  "settings.orchestration.row.reviewerModel.title": "Reviewer model",
  "settings.orchestration.row.reviewerModel.description": "Model for the reviewer agent in the format provider/model",
  "settings.orchestration.row.reviewerModel.placeholder": "provider/model",
  "settings.orchestration.row.guruModel.title": "Guru model",
  "settings.orchestration.row.guruModel.description": "Smartest model for one-shot guidance when the brain is stuck; you bear the cost",
  "settings.orchestration.row.guruModel.placeholder": "provider/model",
  "settings.orchestration.row.computerAidModel.title": "Computer aid model",
  "settings.orchestration.row.computerAidModel.description": "Model for the computer-aid agent in the format provider/model",
  "settings.orchestration.row.computerAidModel.placeholder": "provider/model",
  "settings.orchestration.row.classifierModel.title": "Classifier model",
  "settings.orchestration.row.classifierModel.description": "Model for the classifier decision agent in the format provider/model",
  ...
  "settings.providers.section.routing": "Směrování modelů",
  "settings.providers.routing.title": "Strategie směrování",
  "settings.providers.routing.description": "Jak OpenRouter vybírá poskytovatele na pozadí pro každý požadavek.",
  "settings.providers.routing.price": "Nejnižší cena",
  "settings.providers.routing.throughput": "Nejvyšší propustnost",
  ...
  "settings.plugins.title": "Plugins & Skills",
  "settings.plugins.description": "Manage plugins and skills for this server.",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Manage skills for this server.",
  ...
  "settings.plugins.plugins.add.browse": "Procházet…",
  ...
  "settings.plugins.plugins.remove": "Remove",
  "settings.plugins.plugins.count.one": "{{count}} plugin",
  "settings.plugins.plugins.count.other": "{{count}} plugins",
  "settings.plugins.skills.empty": "No skills found",
  "settings.plugins.skills.hint": "Skills are discovered from SKILL.md files in your project and config directories.",
  "settings.plugins.skills.count.one": "{{count}} skill",
  "settings.plugins.skills.count.other": "{{count}} skills",
  "settings.plugins.skills.search.placeholder": "Search skills",
  "settings.plugins.skills.directories.title": "Složky dovedností",
  "settings.plugins.skills.directories.hint":
    "Vypnutím složky vyloučíte její dovednosti z vyhledávání. Soubory zůstanou na disku.",
  "settings.plugins.skills.directories.toggle": "Přepnout složku dovedností {{directory}}",
  "settings.plugins.skills.directories.disabled": "Vypnuto",
  "settings.plugins.skills.directories.toggle.failed": "Nepodařilo se aktualizovat složky dovedností",
  ...
  "settings.plugins.skills.add.title": "Add skills",
  "settings.plugins.skills.add.browse": "Browse…",
  "settings.plugins.skills.add.placeholder": "Directory path or URL",
  "settings.plugins.skills.add.failed": "Failed to add skills",
  "settings.plugins.skills.toggle": "Toggle skill {{skill}}",
  "settings.plugins.skills.toggle.failed": "Failed to update skills",
  "settings.plugins.skills.directories.remove": "Remove",
  "settings.plugins.skills.directories.remove.failed": "Failed to remove skills directory",
  "settings.plugins.plugins.count.few": "{{count}} pluginy",
  "settings.plugins.plugins.count.many": "{{count}} pluginů",
  "settings.plugins.skills.count.few": "{{count}} dovednosti",
  "settings.plugins.skills.count.many": "{{count}} dovedností",
