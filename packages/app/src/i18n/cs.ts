export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Barva textu zpráv uživatele",
  "settings.general.row.userMessageTextColor.description": "Nastavte barvu textu uživatelských zpráv",
