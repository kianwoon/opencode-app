export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "အသုံးပြုသူ စာသားအရောင်",
  "settings.general.row.userMessageTextColor.description": "အသုံးပြုသူ စာများ၏ စာသားအရောင်ကို သတ်မှတ်ပါ",
