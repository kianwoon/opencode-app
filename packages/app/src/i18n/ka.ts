export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "მომხმარებლის შეტყობინებების ტექსტის ფერი",
  "settings.general.row.userMessageTextColor.description": "დააზუსტეთ მომხმარებლის შეტყობინებების ტექსტის ფერი",
