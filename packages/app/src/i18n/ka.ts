export const dict = {
  ...
  "command.session.search": "შეტყობინებების ძებნა",
  "command.session.search.description": "მოძებნეთ შეტყობინებები ამ სესიაში",
  ...
  "dialog.search.empty": "შესატყვისი შეტყობინებები არ არის",
  ...
  "settings.general.row.messageWidth.title": "შეტყობინების სიგანე",
  "settings.general.row.messageWidth.description": "დააყენეთ, რამდენად ფართო შეიძლება იყოს მომხმარებლის შეტყობინებები მიმოწერაში",
  "settings.general.row.messageWidth.option.default": "ნაგულისხმევი",
  "settings.general.row.messageWidth.option.wide": "ფართო",
  ...
  "settings.general.row.messageAlign.option.center": "ცენტრში",
  "settings.general.row.messageAlign.option.right": "მარჯვნივ",
  "settings.general.row.messageBorder.title": "შეტყობინებების ჩარჩო",
  "settings.general.row.messageBorder.description": "დააზუსტეთ მომხმარებლის შეტყობინებების ჩარჩოს ფერი და სისქე",
  "settings.general.row.messageBorder.width.none": "არაფერი",
  "settings.general.row.messageBackground.title": "შეტყობინებების ფონი",
  "settings.general.row.messageBackground.description": "დააზუსტეთ მომხმარებლის შეტყობინებების ფონის ფერი",
  "settings.general.row.userMessageFont.title": "მომხმარებლის შეტყობინებების ტექსტის ფერი",
  "settings.general.row.userMessageFont.description": "დააზუსტეთ მომხმარებლის შეტყობინებების ტექსტის ფერი",
  ...
  "settings.providers.section.routing": "მოდელების როუტინგი",
  "settings.providers.routing.title": "როუტინგის სტრატეგია",
  "settings.providers.routing.description": "OpenRouter როგორ ირჩევს საბექენდ მომწოდებელს თითოეული მოთხოვნისთვის.",
  "settings.providers.routing.price": "ყველაზე დაბალი ფასი",
  "settings.providers.routing.throughput": "უმაღლესი გამტარუნარიანობა",
  ...
  "settings.plugins.plugins.add.browse": "არჩევა…",
  ...
  "settings.plugins.skills.directories.title": "უნარების დირექტორიები",
  "settings.plugins.skills.directories.hint":
    "დირექტორიის გამორთვა გამორთავს მის უნარებს აღმოჩენიდან. ფაილები რჩება დისკზე.",
  "settings.plugins.skills.directories.toggle": "გადართე უნარების დირექტორია {{directory}}",
  "settings.plugins.skills.directories.disabled": "გამორთ.",
  "settings.plugins.skills.directories.toggle.failed": "უნარების დირექტორიების განახლება ვერ მოხერხდა",
