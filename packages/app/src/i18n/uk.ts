export const dict = {
  ...
  "sidebar.tasks.title": "Завдання",
  "sidebar.tasks.new": "Нове завдання",
  "sidebar.tasks.loading": "Завантаження завдань...",
  "sidebar.tasks.empty": "Немає запланованих завдань",
  "sidebar.tasks.pause": "Призупинити завдання",
  "sidebar.tasks.resume": "Відновити завдання",
  "sidebar.tasks.runNow": "Запустити зараз",
  "dialog.task.new.title": "Нове завдання",
  "dialog.task.title": "Назва",
  "dialog.task.title.placeholder": "напр. Щотижневий огляд залежностей",
  "dialog.task.prompt": "Промпт",
  "dialog.task.prompt.placeholder": "Що агент має робити під час кожного запуску?",
  "dialog.task.cron": "Розклад",
  "dialog.task.cron.expression": "Вираз cron",
  "dialog.task.cron.preset.hourly": "Щогодини",
  "dialog.task.cron.preset.daily": "Щодня",
  "dialog.task.cron.preset.weekly": "Щотижня",
  "dialog.task.cron.preset.monthly": "Щомісяця",
  "dialog.task.cron.preset.custom": "Інше",
  ...
  "settings.general.row.messageWidth.title": "Ширина повідомлень",
  "settings.general.row.messageWidth.description": "Укажіть, якої ширини можуть бути повідомлення користувача в листуванні",
  "settings.general.row.messageWidth.option.default": "За замовчуванням",
  "settings.general.row.messageWidth.option.wide": "Широка",
  ...
  "settings.general.row.messageAlign.option.center": "По центру",
  "settings.general.row.messageAlign.option.right": "Праворуч",
  "settings.general.row.messageBorder.title": "Рамка повідомлень",
  "settings.general.row.messageBorder.description": "Задайте колір і товщину рамки навколо повідомлень користувача",
  "settings.general.row.messageBorder.width.none": "Немає",
  "settings.general.row.messageBackground.title": "Фон повідомлень",
  "settings.general.row.messageBackground.description": "Задайте колір фону повідомлень користувача",
  "settings.general.row.userMessageFont.title": "Колір тексту повідомлень користувача",
  "settings.general.row.userMessageFont.description": "Задайте колір тексту повідомлень користувача",
  ...
  "settings.general.row.fontWeight.extraLight": "Надсвітлий",
  "settings.general.row.fontWeight.light": "Світлий",
  "settings.general.row.fontWeight.regular": "Звичайний",
  ...
  "settings.providers.section.routing": "Маршрутизація моделей",
  "settings.providers.routing.title": "Стратегія маршрутизації",
  "settings.providers.routing.description": "Як OpenRouter обирає резервного постачальника для кожного запиту.",
  "settings.providers.routing.price": "Найнижча ціна",
  "settings.providers.routing.throughput": "Найбільша пропускна здатність",
  "settings.providers.routing.latency": "Найменша затримка",
  ...
  "settings.plugins.plugins.add.browse": "Огляд…",
  ...
  "settings.plugins.skills.directories.title": "Папки навичок",
  "settings.plugins.skills.directories.hint":
    "Вимкнення папки виключає її навички з виявлення. Файли залишаються на диску.",
  "settings.plugins.skills.directories.toggle": "Перемкнути папку навичок {{directory}}",
  "settings.plugins.skills.directories.disabled": "Вимк.",
  "settings.plugins.skills.directories.toggle.failed": "Не вдалося оновити папки навичок",
  ...
  "settings.plugins.plugins.count.few": "{{count}} плагіни",
  "settings.plugins.plugins.count.many": "{{count}} плагінів",
  "settings.plugins.skills.count.few": "{{count}} навички",
  "settings.plugins.skills.count.many": "{{count}} навичок",
