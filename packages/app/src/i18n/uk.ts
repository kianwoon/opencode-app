export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Колір тексту повідомлень користувача",
  "settings.general.row.userMessageTextColor.description": "Задайте колір тексту повідомлень користувача",
