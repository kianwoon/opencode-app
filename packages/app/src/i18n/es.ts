export const dict = {
  ...
  "sidebar.drop.title": "Arrastra una carpeta aquí para añadir un proyecto",
  "sidebar.drop.foldersOnly": "Solo se pueden añadir carpetas como proyectos",
  "sidebar.tasks.title": "Tareas",
  "sidebar.tasks.new": "Nueva tarea",
  "sidebar.tasks.loading": "Cargando tareas...",
  "sidebar.tasks.empty": "No hay tareas programadas",
  "sidebar.tasks.pause": "Pausar tarea",
  "sidebar.tasks.resume": "Reanudar tarea",
  "sidebar.tasks.runNow": "Ejecutar ahora",
  "dialog.task.new.title": "Nueva tarea",
  "dialog.task.title": "Título",
  "dialog.task.title.placeholder": "p. ej. Revisión semanal de dependencias",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "¿Qué debe hacer el agente en cada ejecución?",
  "dialog.task.cron": "Programación",
  "dialog.task.cron.expression": "Expresión cron",
  "dialog.task.cron.preset.hourly": "Cada hora",
  "dialog.task.cron.preset.daily": "Cada día",
  "dialog.task.cron.preset.weekly": "Cada semana",
  "dialog.task.cron.preset.monthly": "Cada mes",
  "dialog.task.cron.preset.custom": "Personalizado",
  ...
  "settings.general.row.messageWidth.title": "Ancho del mensaje",
  "settings.general.row.messageWidth.description": "Define el ancho máximo de los mensajes del usuario en la conversación",
  "settings.general.row.messageWidth.option.default": "Predeterminado",
  "settings.general.row.messageWidth.option.wide": "Ancho",
  ...
  "settings.general.row.messageAlign.option.right": "Derecha",
  "settings.general.row.messageBorder.title": "Borde de mensajes",
  "settings.general.row.messageBorder.description": "Definir el color y grosor del borde de los mensajes del usuario",
  "settings.general.row.messageBorder.width.none": "Ninguno",
  "settings.general.row.messageBackground.title": "Fondo de mensajes",
  "settings.general.row.messageBackground.description": "Definir el color de fondo de los mensajes del usuario",
  "settings.general.row.userMessageFont.title": "Color de texto de los mensajes del usuario",
  "settings.general.row.userMessageFont.description": "Definir el color del texto de los mensajes del usuario",
  ...
  "settings.providers.section.routing": "Enrutamiento de modelos",
  "settings.providers.routing.title": "Estrategia de enrutamiento",
  "settings.providers.routing.description": "Cómo selecciona OpenRouter el proveedor subyacente para cada solicitud.",
  "settings.providers.routing.price": "Precio más bajo",
  "settings.providers.routing.throughput": "Mayor rendimiento",
  "settings.providers.routing.latency": "Latencia más baja",
  ...
  "settings.plugins.plugins.add.browse": "Examinar…",
  ...
  "settings.plugins.skills.directories.title": "Directorios de skills",
  "settings.plugins.skills.directories.hint":
    "Desactiva un directorio para excluir sus skills del descubrimiento. Los archivos se conservan en el disco.",
  "settings.plugins.skills.directories.toggle": "Alternar directorio de skills {{directory}}",
  "settings.plugins.skills.directories.disabled": "Desactivado",
  "settings.plugins.skills.directories.toggle.failed": "No se pudieron actualizar los directorios de skills",
