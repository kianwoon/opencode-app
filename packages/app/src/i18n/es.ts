export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Color de texto de los mensajes del usuario",
  "settings.general.row.userMessageTextColor.description": "Definir el color del texto de los mensajes del usuario",
