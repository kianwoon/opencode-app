...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Tekstfarge for brukermeldinger",
  "settings.general.row.userMessageTextColor.description": "Angi tekstfarge for brukermeldinger",
