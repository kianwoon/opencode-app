...
export const dict = {
  ...
  "command.session.search": "Søk i meldinger",
  "command.session.search.description": "Søk i meldingene i denne sesjonen",
  ...
  "dialog.search.empty": "Ingen samsvarende meldinger",
  ...
  "settings.general.row.messageWidth.title": "Meldingsbredde",
  "settings.general.row.messageWidth.description": "Angi hvor brede brukermeldinger kan være i samtalen",
  ...
  "settings.general.row.messageAlign.option.center": "Midtstilt",
  "settings.general.row.messageAlign.option.right": "Høyre",
  "settings.general.row.messageBorder.title": "Meldingsramme",
  "settings.general.row.messageBorder.description": "Angi farge og tykkelse på rammen rundt brukermeldinger",
  "settings.general.row.messageBorder.width.none": "Ingen",
  "settings.general.row.messageBackground.title": "Meldingsbakgrunn",
  "settings.general.row.messageBackground.description": "Angi bakgrunnsfarge for brukermeldinger",
  "settings.general.row.userMessageFont.title": "Tekstfarge for brukermeldinger",
  "settings.general.row.userMessageFont.description": "Angi tekstfarge for brukermeldinger",
  "settings.general.row.uiFont.title": "UI-skrift",
  "settings.general.row.uiFont.description": "Tilpass skrifttypen som brukes i hele grensesnittet",
  "settings.general.row.fontWeight.thin": "Tynn",
  "settings.general.row.fontWeight.extraLight": "Ekstra lys",
  "settings.general.row.fontWeight.light": "Lys",
  ...
  "settings.providers.section.routing": "Modellruting",
  "settings.providers.routing.title": "Rutingstrategi",
  "settings.providers.routing.description": "Hvordan OpenRouter velger underliggende leverandør for hver forespørsel.",
  "settings.providers.routing.price": "Laveste pris",
  "settings.providers.routing.throughput": "Høyest gjennomstrømning",
  ...
  "settings.plugins.plugins.add.browse": "Bla gjennom…",
  ...
  "settings.plugins.skills.directories.title": "Ferdighetsmapper",
  "settings.plugins.skills.directories.hint":
    "Å slå av en mappe utelukker dens ferdigheter fra søket. Filene beholdes på disken.",
  "settings.plugins.skills.directories.toggle": "Bytt ferdighetsmappe {{directory}}",
  "settings.plugins.skills.directories.disabled": "Av",
  "settings.plugins.skills.directories.toggle.failed": "Kunne ikke oppdatere ferdighetsmapper",
  ...
  "sidebar.tasks.title": "Oppgaver",
  "sidebar.tasks.new": "Ny oppgave",
  "sidebar.tasks.loading": "Laster oppgaver...",
  "sidebar.tasks.empty": "Ingen planlagte oppgaver",
  "sidebar.tasks.pause": "Sett oppgave på pause",
  "sidebar.tasks.resume": "Fortsett oppgave",
  "sidebar.tasks.runNow": "Kjør nå",
  "dialog.task.new.title": "Ny oppgave",
  "dialog.task.title": "Tittel",
  "dialog.task.title.placeholder": "f.eks. Ukentlig avhengighetsgjennomgang",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Hva skal agenten gjøre ved hver kjøring?",
  "dialog.task.cron": "Timeplan",
  "dialog.task.cron.expression": "Cron-uttrykk",
  "dialog.task.cron.preset.hourly": "Hver time",
  "dialog.task.cron.preset.daily": "Hver dag",
  "dialog.task.cron.preset.weekly": "Hver uke",
  "dialog.task.cron.preset.monthly": "Hver måned",
  "dialog.task.cron.preset.custom": "Egendefinert",
