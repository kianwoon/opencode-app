export const dict = {
  ...
  "sidebar.tasks.title": "Opgaver",
  "sidebar.tasks.new": "Ny opgave",
  "sidebar.tasks.loading": "Indlæser opgaver...",
  "sidebar.tasks.empty": "Ingen planlagte opgaver",
  "sidebar.tasks.pause": "Sæt opgave på pause",
  "sidebar.tasks.resume": "Genoptag opgave",
  "sidebar.tasks.runNow": "Kør nu",
  "dialog.task.new.title": "Ny opgave",
  "dialog.task.title": "Titel",
  "dialog.task.title.placeholder": "f.eks. Ugentlig afhængighedsgennemgang",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Hvad skal agenten gøre ved hver kørsel?",
  "dialog.task.cron": "Tidsplan",
  "dialog.task.cron.expression": "Cron-udtryk",
  "dialog.task.cron.preset.hourly": "Hver time",
  "dialog.task.cron.preset.daily": "Hver dag",
  "dialog.task.cron.preset.weekly": "Hver uge",
  "dialog.task.cron.preset.monthly": "Hver måned",
  "dialog.task.cron.preset.custom": "Brugerdefineret",
  ...
  "settings.general.row.messageWidth.title": "Beskedbredde",
  "settings.general.row.messageWidth.description": "Angiv hvor brede brugerbeskeder kan være i samtalen",
  ...
  "settings.general.row.messageAlign.option.center": "Centreret",
  "settings.general.row.messageAlign.option.right": "Højre",
  "settings.general.row.messageBorder.title": "Beskedramme",
  "settings.general.row.messageBorder.description": "Angiv farve og tykkelse på rammen omkring brugerbeskeder",
  "settings.general.row.messageBorder.width.none": "Ingen",
  "settings.general.row.messageBackground.title": "Beskedbaggrund",
  "settings.general.row.messageBackground.description": "Angiv baggrundsfarve for brugerbeskeder",
  "settings.general.row.userMessageFont.title": "Tekstfarve for brugerbeskeder",
  "settings.general.row.userMessageFont.description": "Angiv tekstfarve for brugerbeskeder",
  ...
  "settings.general.row.fontWeight.regular": "Almindelig",
  "settings.general.row.fontWeight.medium": "Medium",
  "settings.general.row.fontWeight.semibold": "Halvfed",
  "settings.general.row.fontWeight.bold": "Fed",
  "settings.general.row.fontColor.help": "Farve: lys / mørk",
  ...
  "settings.providers.section.routing": "Modelrouting",
  "settings.providers.routing.title": "Routingstrategi",
  "settings.providers.routing.description":
    "Hvordan OpenRouter vælger den underliggende udbyder for hver forespørgsel.",
  "settings.providers.routing.price": "Laveste pris",
  "settings.providers.routing.throughput": "Højest gennemløb",
  "settings.providers.routing.latency": "Laveste latenstid",
  ...
  "settings.plugins.plugins.add.browse": "Gennemse…",
  ...
  "settings.plugins.skills.directories.title": "Færdighedsmapper",
  "settings.plugins.skills.directories.hint":
    "Slå en mappe fra for at udelukke dens færdigheder fra registrering. Filerne gemmes på disken.",
  "settings.plugins.skills.directories.toggle": "Skift færdighedsmappe {{directory}}",
  "settings.plugins.skills.directories.disabled": "Fra",
  "settings.plugins.skills.directories.toggle.failed": "Kunne ikke opdatere færdighedsmapper",
