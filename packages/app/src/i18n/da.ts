export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Tekstfarve for brugerbeskeder",
  "settings.general.row.userMessageTextColor.description": "Angiv tekstfarve for brugerbeskeder",
