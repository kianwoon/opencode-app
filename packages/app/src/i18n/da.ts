export const dict = {
  ...
  "settings.providers.routing.description": "Hvordan OpenRouter vælger den underliggende udbyder for hver forespørgsel.",
  ...
  "settings.plugins.skills.directories.hint": "Slå en mappe fra for at udelukke dens færdigheder fra registrering. Filerne gemmes på disken.",
