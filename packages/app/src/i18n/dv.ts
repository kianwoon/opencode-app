export const dict = {
  ...
  "command.session.search": "މެސެޖުތައް ހޯދާށެވެ",
  "command.session.search.description": "މި ސެޝަންގައި ހުރި މެސެޖުތައް ހޯދާށެވެ",
  ...
  "dialog.search.empty": "އެއްގޮތް މެސެޖެއް ނެތެވެ",
  ...
  "settings.general.row.messageWidth.title": "މެސެޖުގެ ފުޅާމިން",
  "settings.general.row.messageWidth.description": "ޗެޓުގައި ޔޫޒަރުގެ މެސެޖުތައް ކޮންވެސް ފުޅާވެވޭނެ ތަކެތި ކަނޑައަޅާށި",
  "settings.general.row.messageWidth.option.default": "ޑިފޯލްޓް",
  "settings.general.row.messageWidth.option.wide": "ފުޅާ",
  ...
  "settings.general.row.messageAlign.option.center": "މެދު",
  "settings.general.row.messageAlign.option.right": "އަނާޅު",
  "settings.general.row.messageBorder.title": "މެސެޖުގެ ބޯޑަރ",
  "settings.general.row.messageBorder.description": "ޔޫޒަރުގެ މެސެޖުގެ ބޯޑަރގެ ކުލަ އަދި ފުރިހަމަކަން ކަނޑައަޅާށެވެ",
  "settings.general.row.messageBorder.width.none": "ނުވޭ",
  "settings.general.row.messageBackground.title": "މެސެޖުގެ ފަހަތު",
  "settings.general.row.messageBackground.description": "ޔޫޒަރުގެ މެސެޖުގެ ފަހަތުގެ ކުލަ ކަނޑައަޅާށެވެ",
  "settings.general.row.userMessageFont.title": "ޔޫޒަރުގެ މެސެޖުގެ ލިޔުމުގެ ކުލަ",
  "settings.general.row.userMessageFont.description": "ޔޫޒަރުގެ މެސެޖުގެ ލިޔުމުގެ ކުލަ ކަނޑައަޅާށެވެ",
  ...
  "settings.providers.section.routing": "މޮޑެލް ރޫޓިންގ",
  "settings.providers.routing.title": "ރޫޓިންގ ސްޓްރެޓީޖީ",
  "settings.providers.routing.description":
    "ކޮންމެ އެދޭރެއްގެ ވެސް OpenRouter ކޮން ބެކިންގ ޕްރޮވައިޑަރެއް ހޮވާނީ ކިހިންނާނީއެއް.",
