export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "የተጠቃሚ መልዕክት ጽሑፍ ቀለም",
  "settings.general.row.userMessageTextColor.description": "የተጠቃሚ መልዕክቶችን የጽሑፍ ቀለም ያስተካክሉ",
