export const dict = {
  ...
  "command.session.search": "መልዕክቶችን ፈልግ",
  "command.session.search.description": "በዚህ ክፍለ ጊዜ ውስጥ ያሉትን መልዕክቶች ፈልግ",
  ...
  "dialog.search.empty": "የሚዛመዱ መልዕክቶች የሉም",
  ...
  "settings.general.row.messageWidth.title": "የመልእክት ስፋት",
  "settings.general.row.messageWidth.description": "በውይይቱ ውስጥ የተጠቃሚ መልእክቶች ምን ያህል ሰፊ እንደሆኑ ያስተካክሉ",
  "settings.general.row.messageWidth.option.default": "ነባሪ",
  "settings.general.row.messageWidth.option.wide": "ሰፊ",
  ...
  "settings.general.row.messageAlign.option.center": "መሃል",
  "settings.general.row.messageAlign.option.right": "ቀኝ",
  "settings.general.row.messageBorder.title": "የመልዕክት ጠርዝ",
  "settings.general.row.messageBorder.description": "የተጠቃሚ መልዕክቶችን የጠርዝ ቀለምና ውፍረት ያስተካክሉ",
  "settings.general.row.messageBorder.width.none": "አልባ",
  "settings.general.row.messageBackground.title": "የመልዕክት ዳራ",
  "settings.general.row.messageBackground.description": "የተጠቃሚ መልዕክቶችን የዳራ ቀለም ያስተካክሉ",
  "settings.general.row.userMessageFont.title": "የተጠቃሚ መልዕክት ጽሑፍ ቀለም",
  "settings.general.row.userMessageFont.description": "የተጠቃሚ መልዕክቶችን የጽሑፍ ቀለም ያስተካክሉ",
  ...
  "settings.general.row.fontWeight.extraLight": "እጅግ ቀላል",
  "settings.general.row.fontWeight.light": "ቀላል",
  "settings.general.row.fontWeight.regular": "መደበኛ",
  ...
  "settings.providers.section.routing": "የሞዴል ማስተላለፍ",
  "settings.providers.routing.title": "የማስተላለፍ ስትራቴጂ",
  "settings.providers.routing.description": "OpenRouter ለእያንዳንዱ ጥያቄ የኋላኛውን አቅራቢ እንዴት እንደሚመርጥ።",
  ...
  "settings.plugins.plugins.add.browse": "ያስሱ…",
