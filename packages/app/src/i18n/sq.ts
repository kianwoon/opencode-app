export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Ngjyra e tekstit të mesazheve të përdoruesit",
  "settings.general.row.userMessageTextColor.description": "Caktoni ngjyrën e tekstit të mesazheve të përdoruesit",
