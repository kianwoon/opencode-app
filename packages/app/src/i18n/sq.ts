export const dict = {
  ...
  "command.session.search": "Kërko mesazhe",
  "command.session.search.description": "Kërkoni mesazhet në këtë seancë",
  ...
  "dialog.search.empty": "Nuk ka mesazhe që përputhen",
  ...
  "settings.general.row.messageWidth.title": "Gjerësia e mesazhit",
  "settings.general.row.messageWidth.description": "Caktoni sa të gjerë mund të jenë mesazhet e përdoruesit në bisedë",
  "settings.general.row.messageWidth.option.default": "E parazgjedhur",
  "settings.general.row.messageWidth.option.wide": "E gjerë",
  ...
  "settings.general.row.messageAlign.option.center": "Në qendër",
  "settings.general.row.messageAlign.option.right": "Djathtas",
  "settings.general.row.messageBorder.title": "Korniza e mesazheve",
  "settings.general.row.messageBorder.description": "Caktoni ngjyrën dhe trashësinë e kornizës rreth mesazheve të përdoruesit",
  "settings.general.row.messageBorder.width.none": "Asnjë",
  "settings.general.row.messageBackground.title": "Sfondi i mesazheve",
  "settings.general.row.messageBackground.description": "Caktoni ngjyrën e sfondit të mesazheve të përdoruesit",
  "settings.general.row.userMessageFont.title": "Ngjyra e tekstit të mesazheve të përdoruesit",
  "settings.general.row.userMessageFont.description": "Caktoni ngjyrën e tekstit të mesazheve të përdoruesit",
  ...
  "settings.providers.section.routing": "Rrugëzimi i modeleve",
  "settings.providers.routing.title": "Strategjia e rrugëzimit",
  "settings.providers.routing.description": "Si zgjedh OpenRouter ofruesin mbështetës për çdo kërkesë.",
  "settings.providers.routing.price": "Çmimi më i ulët",
  "settings.providers.routing.throughput": "Xhierja më e lartë",
