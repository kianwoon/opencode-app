export const dict = {
  ...
  "settings.general.row.messageBorder.title": "Okvir poruka",
  "settings.general.row.messageBorder.description": "Postavite boju i debljinu okvira oko poruka korisnika",
  ...
  "settings.providers.section.routing": "Ruteranje modela",
  "settings.providers.routing.title": "Strategija ruteranja",
  "settings.providers.routing.description": "Kako OpenRouter bira pozadinskog pružaoca za svaki zahtjev.",
  ...
  "settings.plugins.skills.directories.title": "Direktorijumi s vještinama",
  "settings.plugins.skills.directories.hint":
    "Isključivanje direktorijuma isključuje njegove vještine iz otkrivanja. Datoteke ostaju na disku.",
  "settings.plugins.skills.directories.toggle": "Prebaci direktorijum vještina {{directory}}",
  "settings.plugins.skills.directories.disabled": "Isključeno",
  "settings.plugins.skills.directories.toggle.failed": "Ažuriranje direktorijuma vještina nije uspjelo",
  ...
  "settings.plugins.plugins.count.few": "{{count}} plugina",
  "settings.plugins.skills.count.few": "{{count}} skilla",
