...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Felhasználói üzenetek szövegszíne",
  "settings.general.row.userMessageTextColor.description": "Állítsa be a felhasználói üzenetek szövegszínét",
