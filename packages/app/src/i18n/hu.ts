...
export const dict = {
  ...
  "command.session.search": "Üzenetek keresése",
  "command.session.search.description": "Keressen az üzenetek között ebben a munkamenetben",
  ...
  "dialog.search.empty": "Nincsenek egyező üzenetek",
  ...
  "settings.general.row.messageWidth.title": "Üzenetszélesség",
  "settings.general.row.messageWidth.description": "Állítsa be, milyen szélesek lehetnek a felhasználó üzenetei az átiratban",
  "settings.general.row.messageWidth.option.default": "Alapértelmezett",
  "settings.general.row.messageWidth.option.wide": "Széles",
  ...
  "settings.general.row.messageAlign.option.center": "Középre",
  "settings.general.row.messageAlign.option.right": "Jobb",
  "settings.general.row.messageBorder.title": "Üzenetkeret",
  "settings.general.row.messageBorder.description": "Állítsa be a felhasználói üzenetek keretének színét és vastagságát",
  "settings.general.row.messageBorder.width.none": "Nincs",
  "settings.general.row.messageBackground.title": "Üzenetháttér",
  "settings.general.row.messageBackground.description": "Állítsa be a felhasználói üzenetek háttérszínét",
  "settings.general.row.userMessageFont.title": "Felhasználói üzenetek szövegszíne",
  "settings.general.row.userMessageFont.description": "Állítsa be a felhasználói üzenetek szövegszínét",
  ...
  "settings.providers.section.routing": "Modellek útválasztása",
  "settings.providers.routing.title": "Útválasztási stratégia",
  "settings.providers.routing.description": "Hogyan választja ki az OpenRouter a háttérszolgáltatót minden kéréshez.",
  "settings.providers.routing.price": "Legalacsonyabb ár",
  "settings.providers.routing.throughput": "Legnagyobb áteresztőképesség",
  ...
  "settings.plugins.skills.directories.title": "Készségmappák",
  "settings.plugins.skills.directories.hint":
    "Egy mappa kikapcsolása kizárja annak készségeit a felderítésből. A fájlok a lemezen maradnak.",
  "settings.plugins.skills.directories.toggle": "{{directory}} készségmappa kapcsolása",
  "settings.plugins.skills.directories.disabled": "Ki",
  "settings.plugins.skills.directories.toggle.failed": "A készségmappák frissítése sikertelen",
