export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Kasutajasõnumite teksti värv",
  "settings.general.row.userMessageTextColor.description": "Määra kasutajasõnumite teksti värv",
