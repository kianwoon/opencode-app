export const dict = {
  ...
  "command.session.search": "Otsi sõnumeid",
  "command.session.search.description": "Otsige sõnumeid sellest seansist",
  ...
  "dialog.search.empty": "Vastavaid sõnumeid pole",
  ...
  "settings.general.row.messageWidth.title": "Sõnumi laius",
  "settings.general.row.messageWidth.description": "Määra, kui laiad võivad kasutaja sõnumid vestluses olla",
  "settings.general.row.messageWidth.option.default": "Vaikeseade",
  "settings.general.row.messageWidth.option.wide": "Lai",
  ...
  "settings.general.row.messageAlign.option.center": "Keskel",
  "settings.general.row.messageAlign.option.right": "Paremal",
  "settings.general.row.messageBorder.title": "Sõnumite ääris",
  "settings.general.row.messageBorder.description": "Määra kasutaja sõnumite äärise värv ja paksus",
  "settings.general.row.messageBorder.width.none": "Puudub",
  "settings.general.row.messageBackground.title": "Sõnumite taust",
  "settings.general.row.messageBackground.description": "Määra kasutaja sõnumite taustavärv",
  "settings.general.row.userMessageFont.title": "Kasutajasõnumite teksti värv",
  "settings.general.row.userMessageFont.description": "Määra kasutajasõnumite teksti värv",
  ...
  "settings.general.row.fontWeight.thin": "Õhuke",
  "settings.general.row.fontWeight.extraLight": "Eriti hele",
  "settings.general.row.fontWeight.light": "Hele",
  "settings.general.row.fontWeight.regular": "Tavaline",
  ...
  "settings.providers.section.routing": "Mudelite marsruutimine",
  "settings.providers.routing.title": "Marsruutimisstrateegia",
  "settings.providers.routing.description": "Kuidas OpenRouter iga päringu jaoks tagantvarustajat valib.",
  "settings.providers.routing.price": "Madalaim hind",
  "settings.providers.routing.throughput": "Suurim läbilaskevõime",
  ...
  "settings.plugins.plugins.add.browse": "Sirvi…",
  ...
  "settings.plugins.skills.directories.title": "Oskuste kataloogid",
  "settings.plugins.skills.directories.hint":
    "Kataloogi väljalülitamine jätab selle oskused avastamata. Failid jäävad kettale.",
  "settings.plugins.skills.directories.toggle": "Lülita oskuste kataloog {{directory}}",
  "settings.plugins.skills.directories.disabled": "Väljas",
  "settings.plugins.skills.directories.toggle.failed": "Oskuste kataloogide uuendamine nurjus",
