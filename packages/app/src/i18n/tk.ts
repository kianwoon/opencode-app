export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Ulanyjy habarynyň tekst reňki",
  "settings.general.row.userMessageTextColor.description": "Ulanyjy habarlarynyň tekst reňkini kesgitleň",
