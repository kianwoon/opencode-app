export const dict = {
  ...
  "command.session.search": "Hatalary gözläň",
  "command.session.search.description": "Bu sessiýadaky hatalary gözläň",
  ...
  "dialog.search.empty": "Gabat gelýän habar ýok",
  ...
  "settings.general.row.messageWidth.title": "Habaryň ini",
  "settings.general.row.messageWidth.description": "Söhbetdeşlikde ulanyjynyň habarlarynyň nähili in bolup bilýändigini kesgitleň",
  "settings.general.row.messageWidth.option.default": "Başlangyç",
  "settings.general.row.messageWidth.option.wide": "In",
  ...
  "settings.general.row.messageAlign.option.right": "Sag",
  "settings.general.row.messageBorder.title": "Habar çarçywasy",
  "settings.general.row.messageBorder.description": "Ulanyjy habarlarynyň çarçywasyň reňkini we galyňlygyny kesgitleň",
  "settings.general.row.messageBorder.width.none": "Ýok",
  "settings.general.row.messageBackground.title": "Habar fundy",
  "settings.general.row.messageBackground.description": "Ulanyjy habarlarynyň fundyň reňkini kesgitleň",
  "settings.general.row.userMessageFont.title": "Ulanyjy habarynyň tekst reňki",
  "settings.general.row.userMessageFont.description": "Ulanyjy habarlarynyň tekst reňkini kesgitleň",
  ...
  "settings.providers.section.routing": "Model marşrutizasiýasy",
  "settings.providers.routing.title": "Marşrutizasiýa strategiýasy",
  "settings.providers.routing.description": "OpenRouter her isleg üçin yzaky üpjün edijini nähili saýlaýar.",
  "settings.providers.routing.price": "Iň arzan bahasy",
  "settings.providers.routing.throughput": "Iň ýokary geçirijilik",
