export const dict: Record<string, string> = {
  ...
  "settings.general.row.userMessageTextColor.title": "පරිශීලක පණිවිඩවල පෙළ වර්ණය",
  "settings.general.row.userMessageTextColor.description": "පරිශීලක පණිවිඩවල පෙළ වර්ණය සකසන්න",
