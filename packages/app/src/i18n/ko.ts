export const dict = {
  ...
  "command.session.search": "메시지 검색",
  "command.session.search.description": "이 세션의 메시지 검색",
  ...
  "dialog.search.empty": "일치하는 메시지 없음",
  ...
  "settings.general.row.messageWidth.title": "메시지 너비",
  "settings.general.row.messageWidth.description": "대화에서 사용자 메시지의 최대 너비를 설정합니다",
  "settings.general.row.messageWidth.option.default": "기본값",
  "settings.general.row.messageWidth.option.wide": "넓게",
  ...
  "settings.general.row.messageAlign.option.center": "가운데",
  "settings.general.row.messageAlign.option.right": "오른쪽",
  "settings.general.row.messageBorder.title": "메시지 테두리",
  "settings.general.row.messageBorder.description": "사용자 메시지 테두리의 색과 두께 설정",
  "settings.general.row.messageBorder.width.none": "없음",
  "settings.general.row.messageBackground.title": "메시지 배경",
  "settings.general.row.messageBackground.description": "사용자 메시지의 배경색 설정",
  "settings.general.row.userMessageFont.title": "사용자 메시지 텍스트 색상",
  "settings.general.row.userMessageFont.description": "사용자 메시지의 텍스트 색상 설정",
  ...
  "settings.general.row.fontWeight.extraLight": "엑스트라 라이트",
  "settings.general.row.fontWeight.light": "라이트",
  "settings.general.row.fontWeight.regular": "레귤러",
  ...
  "settings.providers.section.routing": "모델 라우팅",
  "settings.providers.routing.title": "라우팅 전략",
  "settings.providers.routing.description": "OpenRouter가 각 요청에 대해 백엔드 공급자를 선택하는 방법입니다.",
  "settings.providers.routing.price": "최저 가격",
  "settings.providers.routing.throughput": "최고 처리량",
  ...
  "settings.plugins.plugins.add.browse": "찾아보기…",
  ...
  "settings.plugins.skills.directories.title": "스킬 디렉터리",
  "settings.plugins.skills.directories.hint":
    "디렉터리를 끄면 해당 스킬이 검색에서 제외됩니다. 파일은 디스크에 그대로 유지됩니다.",
  "settings.plugins.skills.directories.toggle": "스킬 디렉터리 {{directory}} 전환",
  "settings.plugins.skills.directories.disabled": "끔",
  "settings.plugins.skills.directories.toggle.failed": "스킬 디렉터리를 업데이트하지 못했습니다",
  ...
  "sidebar.tasks.title": "작업",
  "sidebar.tasks.new": "새 작업",
  "sidebar.tasks.loading": "작업을 불러오는 중...",
  "sidebar.tasks.empty": "예약된 작업이 없습니다",
  "sidebar.tasks.pause": "작업 일시 중지",
  "sidebar.tasks.resume": "작업 재개",
  "sidebar.tasks.runNow": "지금 실행",
  "dialog.task.new.title": "새 작업",
  "dialog.task.title": "제목",
  "dialog.task.title.placeholder": "예: 주간 종속성 검토",
  "dialog.task.prompt": "프롬프트",
  "dialog.task.prompt.placeholder": "각 실행 시 에이전트가 무엇을 하도록 할까요?",
  "dialog.task.cron": "일정",
  "dialog.task.cron.expression": "cron 표현식",
  "dialog.task.cron.preset.hourly": "매시간",
  "dialog.task.cron.preset.daily": "매일",
  "dialog.task.cron.preset.weekly": "매주",
  "dialog.task.cron.preset.monthly": "매월",
  "dialog.task.cron.preset.custom": "사용자 지정",
