export const dict = {
  ...
  "command.session.search": "Търсене на съобщения",
  "command.session.search.description": "Търсене на съобщенията в тази сесия",
  ...
  "dialog.search.empty": "Няма съвпадащи съобщения",
  ...
  "settings.general.row.messageWidth.title": "Ширина на съобщенията",
  "settings.general.row.messageWidth.description": "Задайте колко широки могат да бъдат съобщенията на потребителя",
  "settings.general.row.messageWidth.option.default": "Стандартно",
  ...
  "settings.general.row.messageAlign.option.right": "Дясно",
  "settings.general.row.messageBorder.title": "Рамка на съобщенията",
  "settings.general.row.messageBorder.description": "Задайте цвета и дебелината на рамката около потребителските съобщения",
  "settings.general.row.messageBorder.width.none": "Няма",
  "settings.general.row.messageBackground.title": "Фон на съобщенията",
  "settings.general.row.messageBackground.description": "Задайте фоновия цвят на потребителските съобщения",
  "settings.general.row.userMessageFont.title": "Цвят на текста на съобщенията",
  "settings.general.row.userMessageFont.description": "Задайте цвета на текста на потребителските съобщения",
  ...
  "settings.providers.section.routing": "Маршрутизиране на модели",
  "settings.providers.routing.title": "Стратегия за маршрутизиране",
  "settings.providers.routing.description": "Как OpenRouter избира основния доставчик за всяка заявка.",
  "settings.providers.routing.price": "Най-ниска цена",
  "settings.providers.routing.throughput": "Най-висока пропускателна способност",
  "settings.providers.routing.latency": "Най-ниска латентност",
  ...
  "settings.plugins.plugins.add.browse": "Разглеждане…",
  ...
  "settings.plugins.skills.directories.title": "Папки с умения",
  "settings.plugins.skills.directories.hint":
    "Изключването на папка изключва нейните умения от откриването. Файловете остават на диска.",
  "settings.plugins.skills.directories.toggle": "Превключи папка с умения {{directory}}",
  "settings.plugins.skills.directories.disabled": "Изключено",
  "settings.plugins.skills.directories.toggle.failed": "Не успя актуализирането на папките с умения",
