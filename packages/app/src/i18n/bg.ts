export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Цвят на текста на съобщенията",
  "settings.general.row.userMessageTextColor.description": "Задайте цвета на текста на потребителските съобщения",
