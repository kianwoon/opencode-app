export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Χρώμα κειμένου μηνυμάτων χρήστη",
  "settings.general.row.userMessageTextColor.description": "Ορίστε το χρώμα κειμένου των μηνυμάτων χρήστη",
