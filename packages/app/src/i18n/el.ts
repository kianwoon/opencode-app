export const dict = {
  ...
  "command.session.search": "Αναζήτηση μηνυμάτων",
  "command.session.search.description": "Αναζήτηση των μηνυμάτων σε αυτή τη συνεδρία",
  ...
  "dialog.search.empty": "Δεν υπάρχουν αντίστοιχα μηνύματα",
  ...
  "settings.general.row.messageWidth.title": "Πλάτος μηνύματος",
  "settings.general.row.messageWidth.description": "Ορίστε πόσο πλα τά μπορούν να είναι τα μηνύματα χρήστη στη συνομιλία",
  "settings.general.row.messageWidth.option.default": "Προεπιλογή",
  "settings.general.row.messageWidth.option.wide": "Φαρδύ",
  ...
  "settings.general.row.messageAlign.option.center": "Κέντρο",
  "settings.general.row.messageAlign.option.right": "Δεξιά",
  "settings.general.row.messageBorder.title": "Πλαίσιο μηνυμάτων",
  "settings.general.row.messageBorder.description": "Ορίστε το χρώμα και το πάχος του πλαισίου γύρω από τα μηνύματα χρήστη",
  "settings.general.row.messageBorder.width.none": "Κανένα",
  "settings.general.row.messageBackground.title": "Φόντο μηνυμάτων",
  "settings.general.row.messageBackground.description": "Ορίστε το χρώμα φόντου των μηνυμάτων χρήστη",
  "settings.general.row.userMessageFont.title": "Χρώμα κειμένου μηνυμάτων χρήστη",
  "settings.general.row.userMessageFont.description": "Ορίστε το χρώμα κειμένου των μηνυμάτων χρήστη",
  ...
  "settings.providers.section.routing": "Δρομολόγηση μοντέλων",
  "settings.providers.routing.title": "Στρατηγική δρομολόγησης",
  "settings.providers.routing.description": "Πώς επιλέγει το OpenRouter τον υποκείμενο πάροχο για κάθε αίτημα.",
  "settings.providers.routing.price": "Χαμηλότερη τιμή",
  "settings.providers.routing.throughput": "Υψηλότερη απόδοση",
  ...
  "settings.plugins.plugins.add.browse": "Αναζήτηση…",
  ...
  "settings.plugins.skills.directories.title": "Φάκελοι δεξιοτήτων",
  "settings.plugins.skills.directories.hint":
    "Η απενεργοποίηση ενός φακέλου εξαιρεί τις δεξιότητές του από την ανακάλυψη. Τα αρχεία παραμένουν στον δίσκο.",
  "settings.plugins.skills.directories.toggle": "Εναλλαγή φακέλου δεξιοτήτων {{directory}}",
  "settings.plugins.skills.directories.disabled": "Ανενεργό",
  "settings.plugins.skills.directories.toggle.failed": "Αποτυχία ενημέρωσης των φακέλων δεξιοτήτων",
