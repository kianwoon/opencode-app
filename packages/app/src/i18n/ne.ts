export const dict: Record<string, string> = {
  ...
  "settings.general.row.userMessageTextColor.title": "प्रयोगकर्ता सन्देश पाठको रङ",
  "settings.general.row.userMessageTextColor.description": "प्रयोगकर्ता सन्देशको पाठको रङ सेट गर्नुहोस्",
