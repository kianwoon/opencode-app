...
export const dict = {
  ...
  "sidebar.tasks.title": "工作",
  "sidebar.tasks.new": "新增工作",
  "sidebar.tasks.loading": "正在載入工作...",
  "sidebar.tasks.empty": "沒有排程工作",
  "sidebar.tasks.pause": "暫停工作",
  "sidebar.tasks.resume": "繼續工作",
  "sidebar.tasks.runNow": "立即執行",
  "dialog.task.new.title": "新增工作",
  "dialog.task.title": "標題",
  "dialog.task.title.placeholder": "例如：每週相依性審查",
  "dialog.task.prompt": "提示詞",
  "dialog.task.prompt.placeholder": "每次執行時要代理做什麼？",
  "dialog.task.cron": "排程",
  "dialog.task.cron.expression": "cron 運算式",
  "dialog.task.cron.preset.hourly": "每小時",
  "dialog.task.cron.preset.daily": "每天",
  "dialog.task.cron.preset.weekly": "每週",
  "dialog.task.cron.preset.monthly": "每月",
  "dialog.task.cron.preset.custom": "自訂",
  ...
  "settings.general.row.messageWidth.title": "訊息寬度",
  "settings.general.row.messageWidth.description": "設定使用者訊息在對話中的最大寬度",
  "settings.general.row.messageWidth.option.default": "預設",
  "settings.general.row.messageWidth.option.wide": "寬",
  ...
  "settings.general.row.messageAlign.option.center": "置中",
  "settings.general.row.messageAlign.option.right": "右",
  "settings.general.row.messageBorder.title": "訊息邊框",
  "settings.general.row.messageBorder.description": "設定使用者訊息邊框的顏色與粗細",
  "settings.general.row.messageBorder.width.none": "無",
  "settings.general.row.messageBackground.title": "訊息背景",
  "settings.general.row.messageBackground.description": "設定使用者訊息的背景色",
  "settings.general.row.userMessageFont.title": "使用者訊息文字顏色",
  "settings.general.row.userMessageFont.description": "設定使用者訊息的文字顏色",
  ...
  "settings.general.row.fontWeight.extraLight": "特細",
  "settings.general.row.fontWeight.light": "細",
  "settings.general.row.fontWeight.regular": "常規",
  ...
  "settings.providers.routing.description": "OpenRouter 如何為每個請求選擇後端供應商。",
  "settings.providers.routing.price": "最低價格",
  ...
  "settings.plugins.title": "外掛程式與技能",
  "settings.plugins.description": "管理此伺服器的外掛程式和技能。",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Manage skills for this server.",
  "settings.plugins.section.plugins": "外掛程式",
  ...
  "settings.plugins.plugins.remove.failed": "移除外掛程式失敗",
  "settings.plugins.plugins.remove": "移除",
  "settings.plugins.plugins.count.one": "{{count}} 個外掛程式",
  "settings.plugins.plugins.count.other": "{{count}} 個外掛程式",
  "settings.plugins.skills.empty": "找不到任何技能",
  "settings.plugins.skills.hint": "技能會從專案和設定目錄中的 SKILL.md 檔案發現。",
  "settings.plugins.skills.count.one": "{{count}} 個技能",
  "settings.plugins.skills.count.other": "{{count}} 個技能",
  "settings.plugins.skills.search.placeholder": "搜尋技能",
  "settings.plugins.skills.directories.title": "技能目錄",
  "settings.plugins.skills.directories.hint": "關閉目錄會將其中的技能排除在探索範圍之外。檔案仍保留在磁碟上。",
  "settings.plugins.skills.directories.toggle": "切換技能目錄 {{directory}}",
  "settings.plugins.skills.directories.disabled": "關",
  "settings.plugins.skills.directories.toggle.failed": "更新技能目錄失敗",
