export const dict: Record<string, string> = {
  ...
  "command.session.search": "འཕྲིན་དོན་ཚུ་འཚོལ།",
  "command.session.search.description": "ལཱ་ཡུན་འདིའི་ནང་ལུ་ འཕྲིན་དོན་ཚུ་འཚོལ།",
  ...
  "dialog.search.empty": "འཚམ་མཐུན་གྱི་འཕྲིན་དོན་མེད།",
  ...
  "settings.general.row.messageWidth.title": "འཕྲིན་དོན་གྱི་རྒྱ་ཚད།",
  "settings.general.row.messageWidth.description": "ཁ་བརྡ་ནང་ལག་ལེན་པའི་འཕྲིན་དོན་རྒྱ་ཚད་ག་དེམ་ཅིག་འབད་བཏུབ་ནི་ཨིན་ན་གཞི་བཙུགས་འབད།",
  "settings.general.row.messageWidth.option.default": "སྤྱི་མཐུན།",
  "settings.general.row.messageWidth.option.wide": "རྒྱ་ཆེཝ།",
  ...
  "settings.general.row.messageAlign.option.center": "དབུས",
  "settings.general.row.messageAlign.option.right": "གཡས",
  "settings.general.row.messageBorder.title": "འཕྲིན་དོན་གྱི་མཐའ་རྩང་",
  "settings.general.row.messageBorder.description": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་མཐའ་རྩང་གི་ཚོན་མདོག་དང་སྟུག་ཚད་གཞི་སྒྲིག་འབད།",
  "settings.general.row.messageBorder.width.none": "མེད",
  "settings.general.row.messageBackground.title": "འཕྲིན་དོན་གྱི་རྒྱབ་ལོག",
  "settings.general.row.messageBackground.description": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་རྒྱབ་ལོག་གི་ཚོན་མདོག་གཞི་སྒྲིག་འབད།",
  "settings.general.row.userMessageFont.title": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་ཚིག་གི་ཚོན་མདོག",
  "settings.general.row.userMessageFont.description": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་ཚིག་གི་ཚོན་མདོག་གཞི་སྒྲིག་འབད།",
