export const dict: Record<string, string> = {
  ...
  "settings.general.row.userMessageTextColor.title": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་ཚིག་གི་ཚོན་མདོག",
  "settings.general.row.userMessageTextColor.description": "ལག་ལེན་པའི་འཕྲིན་དོན་གྱི་ཚིག་གི་ཚོན་མདོག་གཞི་སྒྲིག་འབད།",
