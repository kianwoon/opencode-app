export const dict = {
  ...
  "sidebar.drop.title": "Перетащите папку сюда, чтобы добавить проект",
  "sidebar.drop.foldersOnly": "Добавлять в качестве проектов можно только папки",
  "sidebar.tasks.title": "Задачи",
  "sidebar.tasks.new": "Новая задача",
  "sidebar.tasks.loading": "Загрузка задач...",
  "sidebar.tasks.empty": "Нет запланированных задач",
  "sidebar.tasks.pause": "Приостановить задачу",
  "sidebar.tasks.resume": "Возобновить задачу",
  "sidebar.tasks.runNow": "Запустить сейчас",
  "dialog.task.new.title": "Новая задача",
  "dialog.task.title": "Название",
  "dialog.task.title.placeholder": "напр. Еженедельная проверка зависимостей",
  "dialog.task.prompt": "Промпт",
  "dialog.task.prompt.placeholder": "Что агент должен делать при каждом запуске?",
  "dialog.task.cron": "Расписание",
  "dialog.task.cron.expression": "Выражение cron",
  "dialog.task.cron.preset.hourly": "Ежечасно",
  "dialog.task.cron.preset.daily": "Ежедневно",
  "dialog.task.cron.preset.weekly": "Еженедельно",
  "dialog.task.cron.preset.monthly": "Ежемесячно",
  "dialog.task.cron.preset.custom": "Другое",
  ...
  "settings.general.row.messageWidth.title": "Ширина сообщений",
  "settings.general.row.messageWidth.description": "Укажите, какой ширины могут быть сообщения пользователя в переписке",
  "settings.general.row.messageWidth.option.default": "По умолчанию",
  "settings.general.row.messageWidth.option.wide": "Широкая",
  ...
  "settings.general.row.messageAlign.option.right": "Справа",
  "settings.general.row.messageBorder.title": "Рамка сообщений",
  "settings.general.row.messageBorder.description": "Задать цвет и толщину рамки вокруг сообщений пользователя",
  "settings.general.row.messageBorder.width.none": "Нет",
  "settings.general.row.messageBackground.title": "Фон сообщений",
  "settings.general.row.messageBackground.description": "Задать цвет фона сообщений пользователя",
  "settings.general.row.userMessageFont.title": "Цвет текста сообщений пользователя",
  "settings.general.row.userMessageFont.description": "Задать цвет текста сообщений пользователя",
  ...
  "settings.providers.section.routing": "Маршрутизация моделей",
  "settings.providers.routing.title": "Стратегия маршрутизации",
  "settings.providers.routing.description": "Как OpenRouter выбирает резервного провайдера для каждого запроса.",
  "settings.providers.routing.price": "Самая низкая цена",
  "settings.providers.routing.throughput": "Максимальная пропускная способность",
  "settings.providers.routing.latency": "Минимальная задержка",
  ...
  "settings.plugins.plugins.add.browse": "Обзор…",
  ...
  "settings.plugins.skills.directories.title": "Папки навыков",
  "settings.plugins.skills.directories.hint":
    "При отключении папки её навыки исключаются из обнаружения. Файлы остаются на диске.",
  "settings.plugins.skills.directories.toggle": "Переключить папку навыков {{directory}}",
  "settings.plugins.skills.directories.disabled": "Выкл.",
  "settings.plugins.skills.directories.toggle.failed": "Не удалось обновить папки навыков",
  ...
  "settings.plugins.plugins.count.few": "{{count}} плагина",
  "settings.plugins.plugins.count.many": "{{count}} плагинов",
  "settings.plugins.skills.count.few": "{{count}} навыка",
  "settings.plugins.skills.count.many": "{{count}} навыков",
