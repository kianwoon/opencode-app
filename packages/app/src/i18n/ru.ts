export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Цвет текста сообщений пользователя",
  "settings.general.row.userMessageTextColor.description": "Задать цвет текста сообщений пользователя",
