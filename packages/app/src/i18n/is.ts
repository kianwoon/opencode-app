...
export const dict = {
  ...
  "command.session.search": "Leita að skilaboðum",
  "command.session.search.description": "Leita að skilaboðum í þessari setu",
  ...
  "dialog.search.empty": "Engin samsvarandi skilaboð",
  ...
  "settings.general.row.messageWidth.title": "Breidd skilaboða",
  "settings.general.row.messageWidth.description": "Stilltu hversu breið skilaboð notanda mega vera í samtalinu",
  "settings.general.row.messageWidth.option.default": "Sjálfgefið",
  "settings.general.row.messageWidth.option.wide": "Breitt",
  ...
  "settings.general.row.messageAlign.option.center": "Miðja",
  "settings.general.row.messageAlign.option.right": "Hægri",
  "settings.general.row.messageBorder.title": "Rammi skilaboða",
  "settings.general.row.messageBorder.description": "Stilltu lit og þykkt rammans utan um skilaboð notanda",
  "settings.general.row.messageBorder.width.none": "Ekkert",
  "settings.general.row.messageBackground.title": "Bakgrunnur skilaboða",
  "settings.general.row.messageBackground.description": "Stilltu bakgrunnslit skilaboða notanda",
  "settings.general.row.userMessageFont.title": "Textalitur skilaboða notanda",
  "settings.general.row.userMessageFont.description": "Stilltu textalit skilaboða notanda",
  ...
  "settings.general.row.fontWeight.extraLight": "Extra ljóst",
  "settings.general.row.fontWeight.light": "Ljóst",
  "settings.general.row.fontWeight.regular": "Venjulegt",
  ...
  "settings.providers.section.routing": "Beining módel",
  "settings.providers.routing.title": "Beinarstefna",
  "settings.providers.routing.description": "Hvernig OpenRouter velur bakgrunnsveitu fyrir hverja fyrirspurn.",
  "settings.providers.routing.price": "Lægsta verð",
  "settings.providers.routing.throughput": "Mesta gegnumstreymi",
  ...
  "settings.plugins.plugins.add.browse": "Skoða…",
  ...
  "settings.plugins.skills.directories.title": "Færslur fyrir kunnáttu",
  "settings.plugins.skills.directories.hint":
    "Að slökkva á möppu útilokar kunnáttuna hennar frá leit. Skrárnar eru geymdar á diski.",
  "settings.plugins.skills.directories.toggle": "Víxla kunnáttumöppu {{directory}}",
  "settings.plugins.skills.directories.disabled": "Af",
  "settings.plugins.skills.directories.toggle.failed": "Ekki tókst að uppfæra kunnáttumöppur",
