...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Textalitur skilaboða notanda",
  "settings.general.row.userMessageTextColor.description": "Stilltu textalit skilaboða notanda",
