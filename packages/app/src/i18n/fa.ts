export const dict = {
  ...
  "command.session.search": "جستجوی پیام‌ها",
  "command.session.search.description": "پیام‌های این جلسه را جستجو کنید",
  ...
  "dialog.search.empty": "پیام منطبقی وجود ندارد",
  ...
  "settings.general.row.messageWidth.title": "عرض پیام",
  "settings.general.row.messageWidth.description": "تعیین کنید پیام‌های کاربر در گفتگو حداکثر چقدر عریض باشند",
  "settings.general.row.messageWidth.option.default": "پیش‌فرض",
  "settings.general.row.messageWidth.option.wide": "عریض",
  ...
  "settings.general.row.messageAlign.option.right": "راست",
  "settings.general.row.messageBorder.title": "حاشیه پیام‌ها",
  "settings.general.row.messageBorder.description": "رنگ و ضخامت حاشیه دور پیام‌های کاربر را تعیین کنید",
  "settings.general.row.messageBorder.width.none": "هیچ",
  "settings.general.row.messageBackground.title": "پس‌زمینه پیام‌ها",
  "settings.general.row.messageBackground.description": "رنگ پس‌زمینه پیام‌های کاربر را تعیین کنید",
  "settings.general.row.userMessageFont.title": "رنگ متن پیام‌های کاربر",
  "settings.general.row.userMessageFont.description": "رنگ متن پیام‌های کاربر را تعیین کنید",
  ...
  "settings.general.row.fontWeight.extraLight": "فوق سبک",
  "settings.general.row.fontWeight.light": "سبک",
  "settings.general.row.fontWeight.regular": "معمولی",
  ...
  "settings.providers.section.routing": "مسیریابی مدل",
  "settings.providers.routing.title": "استراتژی مسیریابی",
  "settings.providers.routing.description": "OpenRouter چگونه برای هر درخواست ارائه‌دهنده پشتیبان را انتخاب می‌کند.",
  "settings.providers.routing.price": "کمترین قیمت",
  "settings.providers.routing.throughput": "بیشترین توان عملیاتی",
  ...
  "settings.plugins.plugins.add.browse": "مرور…",
  ...
  "settings.plugins.skills.directories.title": "پوشه‌های مهارت",
  "settings.plugins.skills.directories.hint":
    "خاموش کردن یک پوشه، مهارت‌های آن را از شناسایی حذف می‌کند. فایل‌ها روی دیسک باقی می‌مانند.",
  "settings.plugins.skills.directories.toggle": "تغییر وضعیت پوشه مهارت {{directory}}",
  "settings.plugins.skills.directories.disabled": "خاموش",
  "settings.plugins.skills.directories.toggle.failed": "به‌روزرسانی پوشه‌های مهارت ناموفق بود",
