export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "رنگ متن پیام‌های کاربر",
  "settings.general.row.userMessageTextColor.description": "رنگ متن پیام‌های کاربر را تعیین کنید",
