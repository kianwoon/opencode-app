export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Textfärg för användarmeddelanden",
  "settings.general.row.userMessageTextColor.description": "Ställ in textfärg för användarmeddelanden",
