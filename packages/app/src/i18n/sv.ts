export const dict = {
  ...
  "command.session.search": "Sök meddelanden",
  "command.session.search.description": "Sök meddelandena i den här sessionen",
  ...
  "dialog.search.empty": "Inga matchande meddelanden",
  ...
  "sidebar.tasks.title": "Uppgifter",
  "sidebar.tasks.new": "Ny uppgift",
  "sidebar.tasks.loading": "Läser in uppgifter...",
  "sidebar.tasks.empty": "Inga schemalagda uppgifter",
  "sidebar.tasks.pause": "Pausa uppgift",
  "sidebar.tasks.resume": "Återuppta uppgift",
  "sidebar.tasks.runNow": "Kör nu",
  "dialog.task.new.title": "Ny uppgift",
  "dialog.task.title": "Titel",
  "dialog.task.title.placeholder": "t.ex. Veckovis beroendegranskning",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Vad ska agenten göra vid varje körning?",
  "dialog.task.cron": "Schema",
  "dialog.task.cron.expression": "Cron-uttryck",
  "dialog.task.cron.preset.hourly": "Varje timme",
  "dialog.task.cron.preset.daily": "Varje dag",
  "dialog.task.cron.preset.weekly": "Varje vecka",
  "dialog.task.cron.preset.monthly": "Varje månad",
  "dialog.task.cron.preset.custom": "Anpassad",
  ...
  "settings.general.row.messageWidth.title": "Meddelandebredd",
  "settings.general.row.messageWidth.description": "Ange hur breda användarmeddelanden får vara i konversationen",
  "settings.general.row.messageWidth.option.default": "Standard",
  "settings.general.row.messageWidth.option.wide": "Bred",
  ...
  "settings.general.row.messageAlign.option.center": "Mitten",
  "settings.general.row.messageAlign.option.right": "Höger",
  "settings.general.row.messageBorder.title": "Meddelanderam",
  "settings.general.row.messageBorder.description": "Ställ in färg och tjocklek på ramen runt användarmeddelanden",
  "settings.general.row.messageBorder.width.none": "Ingen",
  "settings.general.row.messageBackground.title": "Meddelandebakgrund",
  "settings.general.row.messageBackground.description": "Ställ in bakgrundsfärg för användarmeddelanden",
  "settings.general.row.userMessageFont.title": "Textfärg för användarmeddelanden",
  "settings.general.row.userMessageFont.description": "Ställ in textfärg för användarmeddelanden",
  ...
  "settings.general.row.fontWeight.extraLight": "Extra ljus",
  "settings.general.row.fontWeight.light": "Ljus",
  "settings.general.row.fontWeight.regular": "Vanlig",
  ...
  "settings.providers.section.routing": "Modellroutning",
  "settings.providers.routing.title": "Routningsstrategi",
  "settings.providers.routing.description": "Hur OpenRouter väljer underliggande leverantör för varje begäran.",
  "settings.providers.routing.price": "Lägsta pris",
  "settings.providers.routing.throughput": "Högst genomströmning",
  "settings.providers.routing.latency": "Lägsta latens",
  ...
  "settings.plugins.plugins.add.browse": "Bläddra…",
  ...
  "settings.plugins.skills.directories.title": "Färdighetsmappar",
  "settings.plugins.skills.directories.hint":
    "Att stänga av en mapp utesluter dess färdigheter från identifieringen. Filerna finns kvar på disken.",
  "settings.plugins.skills.directories.toggle": "Växla färdighetsmapp {{directory}}",
  "settings.plugins.skills.directories.disabled": "Av",
  "settings.plugins.skills.directories.toggle.failed": "Det gick inte att uppdatera färdighetsmappar",
