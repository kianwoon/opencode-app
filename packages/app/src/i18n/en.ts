...
export const dict = {
  ...
  "command.session.search": "Search messages",
  "command.session.search.description": "Search the messages in this session",
  ...
  "dialog.search.empty": "No matching messages",
  ...
  "settings.general.row.messageAlign.option.center": "Center",
  "settings.general.row.messageAlign.option.right": "Right",
  "settings.general.row.messageBorder.title": "Message border",
  "settings.general.row.messageBorder.description": "Set the border color and thickness around user messages",
  "settings.general.row.messageBorder.width.none": "None",
  "settings.general.row.messageBackground.title": "Message background",
  "settings.general.row.messageBackground.description": "Set the background color of user messages",
  ...
  "settings.providers.section.routing": "Model routing",
  "settings.providers.routing.title": "Routing strategy",
  "settings.providers.routing.description": "How OpenRouter selects the backing provider for each request.",
  "settings.providers.routing.price": "Lowest price",
  "settings.providers.routing.throughput": "Highest throughput",
  "settings.providers.routing.latency": "Lowest latency",
  ...
  "settings.plugins.description": "Manage plugins for this server.",
