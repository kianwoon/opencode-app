...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "User message text color",
  "settings.general.row.userMessageTextColor.description": "Set the text color of user messages",
