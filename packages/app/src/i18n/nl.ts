export const dict = {
  ...
  "command.session.search": "Berichten zoeken",
  "command.session.search.description": "Zoek de berichten in deze sessie",
  ...
  "dialog.search.empty": "Geen overeenkomende berichten",
  ...
  "sidebar.tasks.title": "Taken",
  "sidebar.tasks.new": "Nieuwe taak",
  "sidebar.tasks.loading": "Taken laden...",
  "sidebar.tasks.empty": "Geen geplande taken",
  "sidebar.tasks.pause": "Taak pauzeren",
  "sidebar.tasks.resume": "Taak hervatten",
  "sidebar.tasks.runNow": "Nu uitvoeren",
  "dialog.task.new.title": "Nieuwe taak",
  "dialog.task.title": "Titel",
  "dialog.task.title.placeholder": "bijv. Wekelijkse dependencyreview",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Wat moet de agent bij elke uitvoering doen?",
  "dialog.task.cron": "Planning",
  "dialog.task.cron.expression": "Cron-expressie",
  "dialog.task.cron.preset.hourly": "Elk uur",
  "dialog.task.cron.preset.daily": "Dagelijks",
  "dialog.task.cron.preset.weekly": "Wekelijks",
  "dialog.task.cron.preset.monthly": "Maandelijks",
  "dialog.task.cron.preset.custom": "Aangepast",
  ...
  "settings.general.row.messageWidth.title": "Berichtbreedte",
  "settings.general.row.messageWidth.description": "Stel in hoe breed gebruikersberichten mogen zijn in het gesprek",
  "settings.general.row.messageWidth.option.default": "Standaard",
  "settings.general.row.messageWidth.option.wide": "Breed",
  ...
  "settings.general.row.messageAlign.option.center": "Midden",
  "settings.general.row.messageAlign.option.right": "Rechts",
  "settings.general.row.messageBorder.title": "Berichtrand",
  "settings.general.row.messageBorder.description": "Stel de kleur en dikte van de rand om gebruikersberichten in",
  "settings.general.row.messageBorder.width.none": "Geen",
  "settings.general.row.messageBackground.title": "Berichtachtergrond",
  "settings.general.row.messageBackground.description": "Stel de achtergrondkleur van gebruikersberichten in",
  "settings.general.row.userMessageFont.title": "Tekstkleur van gebruikersberichten",
  "settings.general.row.userMessageFont.description": "Stel de tekstkleur van gebruikersberichten in",
  ...
  "settings.providers.section.routing": "Modelroutering",
  "settings.providers.routing.title": "Routeringsstrategie",
  "settings.providers.routing.description": "Hoe OpenRouter de onderliggende provider voor elk verzoek kiest.",
  "settings.providers.routing.price": "Laagste prijs",
  "settings.providers.routing.throughput": "Hoogste doorvoer",
  "settings.providers.routing.latency": "Laagste latentie",
  ...
  "settings.plugins.plugins.add.browse": "Bladeren…",
  ...
  "settings.plugins.skills.directories.title": "Vaardighedenmappen",
  "settings.plugins.skills.directories.hint":
    "Schakel een map uit om de vaardigheden ervan uit te sluiten van detectie. Bestanden blijven op schijf staan.",
  "settings.plugins.skills.directories.toggle": "Vaardighedenmap {{directory}} in-/uitschakelen",
  "settings.plugins.skills.directories.disabled": "Uit",
  "settings.plugins.skills.directories.toggle.failed": "Kon vaardighedenmappen niet bijwerken",
