export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Tekstkleur van gebruikersberichten",
  "settings.general.row.userMessageTextColor.description": "Stel de tekstkleur van gebruikersberichten in",
