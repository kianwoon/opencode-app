export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Ранги матни паёмҳои корбар",
  "settings.general.row.userMessageTextColor.description": "Ранги матни паёмҳои корбарро таъин кунед",
