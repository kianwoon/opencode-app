export const dict = {
  ...
  "command.session.search": "Ҷустуҷӯи паёмҳо",
  "command.session.search.description": "Паёмҳоро дар ин сессия ҷустуҷӯ кунед",
  ...
  "dialog.search.empty": "Паёми мувофиқ ёфт нашуд",
  ...
  "settings.general.row.messageWidth.title": "Бари паёҳо",
  "settings.general.row.messageWidth.description": "Таъин кунед, ки паёмҳои корбар дар сӯҳбат то чӣ андоза васеъ шуда метавонанд",
  "settings.general.row.messageWidth.option.default": "Пешфарз",
  "settings.general.row.messageWidth.option.wide": "Васеъ",
  ...
  "settings.general.row.messageAlign.option.center": "Марказ",
  "settings.general.row.messageAlign.option.right": "Рост",
  "settings.general.row.messageBorder.title": "Ҳошияи паёмҳо",
  "settings.general.row.messageBorder.description": "Рангу ғафсии ҳошияи атрофи паёмҳои корбарро таъин кунед",
  "settings.general.row.messageBorder.width.none": "Ҳеҷ",
  "settings.general.row.messageBackground.title": "Пасзаминаи паёмҳо",
  "settings.general.row.messageBackground.description": "Ранги пасзаминаи паёмҳои корбарро таъин кунед",
  "settings.general.row.userMessageFont.title": "Ранги матни паёмҳои корбар",
  "settings.general.row.userMessageFont.description": "Ранги матни паёмҳои корбарро таъин кунед",
  ...
  "settings.providers.section.routing": "Масирсозии моделҳо",
  "settings.providers.routing.title": "Стратегияи масирсозӣ",
  "settings.providers.routing.description": "OpenRouter барои ҳар дархост провайдери пасиро чӣ тавр интихоб мекунад.",
