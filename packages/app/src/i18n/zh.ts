...
export const dict = {
  ...
  "command.session.search": "搜索消息",
  "command.session.search.description": "搜索此会话中的消息",
  ...
  "sidebar.project.unarchiveSessions": "取消归档最近5个会话",
  "sidebar.project.unarchiveSessions.title": "取消归档最近5个会话",
  "sidebar.project.unarchiveSessions.confirm":
    "要取消归档{{count}}个已归档会话吗？这将恢复最近归档的5个会话。",
  "sidebar.project.unarchiveSessions.description": "已归档会话将恢复到此项目。",
  "sidebar.project.unarchiveSessions.action": "取消归档",
  ...
  "sidebar.tasks.title": "任务",
  "sidebar.tasks.new": "新建任务",
  "sidebar.tasks.loading": "正在加载任务...",
  "sidebar.tasks.empty": "暂无计划任务",
  "sidebar.tasks.pause": "暂停任务",
  "sidebar.tasks.resume": "恢复任务",
  "sidebar.tasks.runNow": "立即运行",
  "dialog.task.new.title": "新建任务",
  "dialog.task.title": "标题",
  "dialog.task.title.placeholder": "例如：每周依赖项检查",
  "dialog.task.prompt": "提示词",
  "dialog.task.prompt.placeholder": "每次运行时希望代理执行什么？",
  "dialog.task.cron": "计划",
  "dialog.task.cron.expression": "cron 表达式",
  "dialog.task.cron.preset.hourly": "每小时",
  "dialog.task.cron.preset.daily": "每天",
  "dialog.task.cron.preset.weekly": "每周",
  "dialog.task.cron.preset.monthly": "每月",
  "dialog.task.cron.preset.custom": "自定义",
  ...
  "settings.general.row.messageWidth.title": "消息宽度",
  "settings.general.row.messageWidth.description": "设置用户消息在对话中的最大宽度",
  "settings.general.row.messageWidth.option.default": "默认",
  "settings.general.row.messageWidth.option.wide": "宽",
  ...
  "settings.general.row.messageAlign.option.center": "居中",
  "settings.general.row.messageAlign.option.right": "右",
  "settings.general.row.messageBorder.title": "消息边框",
  "settings.general.row.messageBorder.description": "设置用户消息边框的颜色和粗细",
  "settings.general.row.messageBorder.width.none": "无",
  "settings.general.row.messageBackground.title": "消息背景",
  "settings.general.row.messageBackground.description": "设置用户消息的背景色",
  "settings.general.row.userMessageFont.title": "用户消息文字颜色",
  "settings.general.row.userMessageFont.description": "设置用户消息的文字颜色",
  ...
  "settings.general.row.fontWeight.extraLight": "特细",
  "settings.general.row.fontWeight.light": "细",
  "settings.general.row.fontWeight.regular": "常规",
  ...
  "settings.plugins.title": "插件与技能",
  "settings.plugins.description": "管理此服务器的插件和技能。",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Manage skills for this server.",
  "settings.plugins.section.plugins": "插件",
  "settings.plugins.section.skills": "技能",
  ...
  "settings.plugins.plugins.remove.failed": "移除插件失败",
  "settings.plugins.plugins.remove": "移除",
  "settings.plugins.plugins.count.one": "{{count}} 个插件",
  "settings.plugins.plugins.count.other": "{{count}} 个插件",
  "settings.plugins.skills.empty": "未找到任何技能",
  "settings.plugins.skills.hint": "技能从项目和配置目录中的 SKILL.md 文件发现。",
  "settings.plugins.skills.count.one": "{{count}} 个技能",
  "settings.plugins.skills.count.other": "{{count}} 个技能",
  "settings.plugins.skills.search.placeholder": "搜索技能",
  "settings.plugins.skills.directories.title": "技能目录",
  "settings.plugins.skills.directories.hint": "关闭目录会将其中的技能排除在发现范围之外。文件仍保留在磁盘上。",
  "settings.plugins.skills.directories.toggle": "切换技能目录 {{directory}}",
  "settings.plugins.skills.directories.disabled": "关",
  "settings.plugins.skills.directories.toggle.failed": "更新技能目录失败",
