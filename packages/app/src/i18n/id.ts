export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Warna teks pesan pengguna",
  "settings.general.row.userMessageTextColor.description": "Atur warna teks pesan pengguna",
