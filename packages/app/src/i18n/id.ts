export const dict = {
  ...
  "sidebar.tasks.title": "Tugas",
  "sidebar.tasks.new": "Tugas baru",
  "sidebar.tasks.loading": "Memuat tugas...",
  "sidebar.tasks.empty": "Tidak ada tugas terjadwal",
  "sidebar.tasks.pause": "Jeda tugas",
  "sidebar.tasks.resume": "Lanjutkan tugas",
  "sidebar.tasks.runNow": "Jalankan sekarang",
  "dialog.task.new.title": "Tugas baru",
  "dialog.task.title": "Judul",
  "dialog.task.title.placeholder": "mis. Tinjauan dependensi mingguan",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Apa yang harus dilakukan agen pada setiap eksekusi?",
  "dialog.task.cron": "Jadwal",
  "dialog.task.cron.expression": "Ekspresi cron",
  "dialog.task.cron.preset.hourly": "Setiap jam",
  "dialog.task.cron.preset.daily": "Harian",
  "dialog.task.cron.preset.weekly": "Mingguan",
  "dialog.task.cron.preset.monthly": "Bulanan",
  "dialog.task.cron.preset.custom": "Kustom",
  ...
  "settings.general.row.messageWidth.title": "Lebar pesan",
  "settings.general.row.messageWidth.description": "Atur seberapa lebar pesan pengguna bisa di transkrip",
  "settings.general.row.messageWidth.option.default": "Bawaan",
  ...
  "settings.general.row.messageAlign.title": "Perataan pesan",
  "settings.general.row.messageAlign.description": "Atur posisi pesan pengguna sejajar di transkrip",
  ...
  "settings.general.row.messageBorder.title": "Bingkai pesan",
  "settings.general.row.messageBorder.description": "Atur warna dan ketebalan bingkai pesan pengguna",
  "settings.general.row.messageBorder.width.none": "Tanpa",
  "settings.general.row.messageBackground.title": "Latar pesan",
  "settings.general.row.messageBackground.description": "Atur warna latar pesan pengguna",
  "settings.general.row.userMessageFont.title": "Warna teks pesan pengguna",
  "settings.general.row.userMessageFont.description": "Atur warna teks pesan pengguna",
  ...
  "settings.providers.routing.description": "Bagaimana OpenRouter memilih penyedia pendukung untuk setiap permintaan.",
  "settings.providers.routing.price": "Harga terendah",
  "settings.providers.routing.throughput": "Throughput tertinggi",
  ...
  "settings.plugins.plugins.add.browse": "Telusuri…",
  ...
  "settings.plugins.skills.directories.title": "Direktori skill",
  "settings.plugins.skills.directories.hint":
    "Matikan direktori untuk mengecualikan skill di dalamnya dari pendeteksiannya. File tetap disimpan di disk.",
  "settings.plugins.skills.directories.toggle": "Alihkan direktori skill {{directory}}",
  "settings.plugins.skills.directories.disabled": "Nonaktif",
  "settings.plugins.skills.directories.toggle.failed": "Gagal memperbarui direktori skill",
