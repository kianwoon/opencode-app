export const dict = {
  ...
  "command.session.search": "Cerca messaggi",
  "command.session.search.description": "Cerca i messaggi in questa sessione",
  ...
  "dialog.search.empty": "Nessun messaggio corrispondente",
  ...
  "sidebar.tasks.title": "Attività",
  "sidebar.tasks.new": "Nuova attività",
  "sidebar.tasks.loading": "Caricamento attività...",
  "sidebar.tasks.empty": "Nessuna attività pianificata",
  "sidebar.tasks.pause": "Metti in pausa l'attività",
  "sidebar.tasks.resume": "Riprendi l'attività",
  "sidebar.tasks.runNow": "Esegui ora",
  "dialog.task.new.title": "Nuova attività",
  "dialog.task.title": "Titolo",
  "dialog.task.title.placeholder": "ad es. Revisione settimanale delle dipendenze",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Cosa deve fare l'agente a ogni esecuzione?",
  "dialog.task.cron": "Pianificazione",
  "dialog.task.cron.expression": "Espressione cron",
  "dialog.task.cron.preset.hourly": "Ogni ora",
  "dialog.task.cron.preset.daily": "Ogni giorno",
  "dialog.task.cron.preset.weekly": "Ogni settimana",
  "dialog.task.cron.preset.monthly": "Ogni mese",
  "dialog.task.cron.preset.custom": "Personalizzato",
  ...
  "settings.general.row.messageWidth.title": "Larghezza messaggio",
  "settings.general.row.messageWidth.description": "Imposta la larghezza massima dei messaggi dell'utente nella conversazione",
  "settings.general.row.messageWidth.option.default": "Predefinito",
  "settings.general.row.messageWidth.option.wide": "Largo",
  ...
  "settings.general.row.messageAlign.option.center": "Centro",
  "settings.general.row.messageAlign.option.right": "Destra",
  "settings.general.row.messageBorder.title": "Bordo messaggi",
  "settings.general.row.messageBorder.description": "Imposta colore e spessore del bordo dei messaggi utente",
  "settings.general.row.messageBorder.width.none": "Nessuno",
  "settings.general.row.messageBackground.title": "Sfondo messaggi",
  "settings.general.row.messageBackground.description": "Imposta il colore di sfondo dei messaggi utente",
  "settings.general.row.userMessageFont.title": "Colore del testo dei messaggi utente",
  "settings.general.row.userMessageFont.description": "Imposta il colore del testo dei messaggi utente",
  ...
  "settings.general.row.fontWeight.regular": "Normale",
  ...
  "settings.providers.section.routing": "Instradamento dei modelli",
  "settings.providers.routing.title": "Strategia di instradamento",
  "settings.providers.routing.description": "Come OpenRouter seleziona il fornitore di back-end per ogni richiesta.",
  "settings.providers.routing.price": "Prezzo più basso",
  "settings.providers.routing.throughput": "Throughput più alto",
  "settings.providers.routing.latency": "Latenza più bassa",
  ...
  "settings.plugins.plugins.add.browse": "Sfoglia…",
  ...
  "settings.plugins.skills.directories.title": "Directory delle skill",
  "settings.plugins.skills.directories.hint":
    "Disattiva una directory per escluderne le skill dal rilevamento. I file restano su disco.",
  "settings.plugins.skills.directories.toggle": "Attiva/disattiva la directory delle skill {{directory}}",
  "settings.plugins.skills.directories.disabled": "Disattivata",
  "settings.plugins.skills.directories.toggle.failed": "Impossibile aggiornare le directory delle skill",
  ...
  "settings.plugins.plugins.count.many": "{{count}} di plugin",
  "settings.plugins.skills.count.many": "{{count}} di skill",
