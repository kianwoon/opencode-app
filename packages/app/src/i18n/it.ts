export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Colore del testo dei messaggi utente",
  "settings.general.row.userMessageTextColor.description": "Imposta il colore del testo dei messaggi utente",
