export const dict = {
  ...
  "command.session.search": "پیغامات تلاش کریں",
  "command.session.search.description": "اس سیشن میں پیغامات تلاش کریں",
  ...
  "dialog.search.empty": "کوئی مماثل پیغامات نہیں",
  ...
  "sidebar.drop.title": "پروجیکٹ شامل کرنے کے لیے فولڈر یہاں چھوڑیں",
  "sidebar.drop.foldersOnly": "پروجیکٹ کے طور پر صرف فولڈر شامل کیے جا سکتے ہیں",
  ...
  "settings.general.row.messageWidth.title": "پیغام کی چوڑائی",
  "settings.general.row.messageWidth.description": "طے کریں کہ گفتگو میں صارف کے پیغامات کتنے چوڑے ہو سکتے ہیں",
  "settings.general.row.messageWidth.option.default": "پہلے سے طے شدہ",
  "settings.general.row.messageWidth.option.wide": "چوڑا",
  ...
  "settings.general.row.messageAlign.option.center": "درمیان",
  "settings.general.row.messageAlign.option.right": "دائیں",
  "settings.general.row.messageBorder.title": "پیغام کا بارڈر",
  "settings.general.row.messageBorder.description": "صارف پیغامات کے بارڈر کا رنگ اور موٹائی مقرر کریں",
  "settings.general.row.messageBorder.width.none": "کوئی نہیں",
  "settings.general.row.messageBackground.title": "پیغام کا پس منظر",
  "settings.general.row.messageBackground.description": "صارف پیغامات کے پس منظر کا رنگ مقرر کریں",
  "settings.general.row.userMessageFont.title": "صارف پیغام کے متن کا رنگ",
  "settings.general.row.userMessageFont.description": "صارف پیغامات کے متن کا رنگ مقرر کریں",
  ...
  "settings.providers.section.routing": "ماڈل روٹنگ",
  "settings.providers.routing.title": "روٹنگ حکمت عملی",
  "settings.providers.routing.description": "OpenRouter ہر درخواست کے لیے سپورٹ فراہم کرنے والے کو کیسے منتخب کرتا ہے۔",
  "settings.providers.routing.price": "کم ترین قیمت",
  "settings.providers.routing.throughput": "اعلیٰ ترین تھروپٹ",
  "settings.providers.routing.latency": "کم ترین تاخیر",
  ...
  "settings.plugins.plugins.add.browse": "براؤز کریں…",
