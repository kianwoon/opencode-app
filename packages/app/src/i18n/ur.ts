export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "صارف پیغام کے متن کا رنگ",
  "settings.general.row.userMessageTextColor.description": "صارف پیغامات کے متن کا رنگ مقرر کریں",
