export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Barva besedila uporabnikovih sporočil",
  "settings.general.row.userMessageTextColor.description": "Nastavite barvo besedila uporabnikovih sporočil",
