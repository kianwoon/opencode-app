export const dict = {
  ...
  "command.session.search": "Išči sporočila",
  "command.session.search.description": "Išči sporočila v tej seji",
  ...
  "dialog.search.empty": "Ni ujemajočih se sporočil",
  ...
  "sidebar.drop.title": "Za dodajanje projekta povlecite mapo sem",
  "sidebar.drop.foldersOnly": "Kot projekte je mogoče dodati samo mape",
  ...
  "settings.general.row.messageWidth.title": "Širina sporočil",
  "settings.general.row.messageWidth.description": "Nastavite, kako široka so lahko uporabnikova sporočila v pogovoru",
  "settings.general.row.messageWidth.option.default": "Privzeto",
  ...
  "settings.general.row.messageAlign.option.center": "Sredinsko",
  "settings.general.row.messageAlign.option.right": "Desno",
  "settings.general.row.messageBorder.title": "Obroba sporočil",
  "settings.general.row.messageBorder.description": "Nastavite barvo in debelino obrobe okoli uporabnikovih sporočil",
  "settings.general.row.messageBorder.width.none": "Brez",
  "settings.general.row.messageBackground.title": "Ozadje sporočil",
  "settings.general.row.messageBackground.description": "Nastavite barvo ozadja uporabnikovih sporočil",
  "settings.general.row.userMessageFont.title": "Barva besedila uporabnikovih sporočil",
  "settings.general.row.userMessageFont.description": "Nastavite barvo besedila uporabnikovih sporočil",
  ...
  "settings.providers.section.routing": "Usmerjanje modelov",
  "settings.providers.routing.title": "Strategija usmerjanja",
  "settings.providers.routing.description": "Kako OpenRouter izbere zadnjega ponudnika za vsako zahtevo.",
  "settings.providers.routing.price": "Najnižja cena",
  "settings.providers.routing.throughput": "Največja prepustnost",
  "settings.providers.routing.latency": "Najnižja zakasnitev",
  ...
  "settings.plugins.plugins.add.browse": "Prebrskaj…",
  ...
  "settings.plugins.skills.directories.title": "Mape z veščinami",
  "settings.plugins.skills.directories.hint":
    "Z izklopom mape izključite njene veščine iz zaznavanja. Datoteke ostanejo na disku.",
  "settings.plugins.skills.directories.toggle": "Preklopi mapo veščin {{directory}}",
  "settings.plugins.skills.directories.disabled": "Izklopljeno",
  "settings.plugins.skills.directories.toggle.failed": "Posodobitev map z veščinami ni uspela",
  ...
  "settings.plugins.plugins.count.two": "{{count}} vtičnika",
  "settings.plugins.plugins.count.few": "{{count}} vtičniki",
  "settings.plugins.skills.count.two": "{{count}} spretnosti",
  "settings.plugins.skills.count.few": "{{count}} spretnosti",
