export const dict = {
  ...
  "command.session.search": "Tìm kiếm tin nhắn",
  "command.session.search.description": "Tìm kiếm tin nhắn trong phiên này",
  ...
  "dialog.search.empty": "Không có tin nhắn phù hợp",
  ...
  "sidebar.tasks.title": "Tác vụ",
  "sidebar.tasks.new": "Tác vụ mới",
  "sidebar.tasks.loading": "Đang tải tác vụ...",
  "sidebar.tasks.empty": "Không có tác vụ đã lên lịch",
  "sidebar.tasks.pause": "Tạm dừng tác vụ",
  "sidebar.tasks.resume": "Tiếp tục tác vụ",
  "sidebar.tasks.runNow": "Chạy ngay",
  "dialog.task.new.title": "Tác vụ mới",
  "dialog.task.title": "Tiêu đề",
  "dialog.task.title.placeholder": "vd. Đánh giá phụ thuộc hàng tuần",
  "dialog.task.prompt": "Prompt",
  "dialog.task.prompt.placeholder": "Bạn muốn agent làm gì trong mỗi lần chạy?",
  "dialog.task.cron": "Lịch",
  "dialog.task.cron.expression": "Biểu thức cron",
  "dialog.task.cron.preset.hourly": "Hàng giờ",
  "dialog.task.cron.preset.daily": "Hàng ngày",
  "dialog.task.cron.preset.weekly": "Hàng tuần",
  "dialog.task.cron.preset.monthly": "Hàng tháng",
  "dialog.task.cron.preset.custom": "Tùy chỉnh",
  ...
  "settings.general.row.messageWidth.title": "Độ rộng tin nhắn",
  "settings.general.row.messageWidth.description": "Đặt chiều rộng tối đa của tin nhắn người dùng trong cuộc trò chuyện",
  "settings.general.row.messageWidth.option.default": "Mặc định",
  "settings.general.row.messageWidth.option.wide": "Rộng",
  ...
  "settings.general.row.messageAlign.option.center": "Giữa",
  "settings.general.row.messageAlign.option.right": "Phải",
  "settings.general.row.messageBorder.title": "Viền tin nhắn",
  "settings.general.row.messageBorder.description": "Đặt màu và độ dày viền quanh tin nhắn người dùng",
  "settings.general.row.messageBorder.width.none": "Không",
  "settings.general.row.messageBackground.title": "Nền tin nhắn",
  "settings.general.row.messageBackground.description": "Đặt màu nền của tin nhắn người dùng",
  "settings.general.row.userMessageFont.title": "Màu chữ của tin nhắn người dùng",
  "settings.general.row.userMessageFont.description": "Đặt màu chữ của tin nhắn người dùng",
  ...
  "settings.providers.section.routing": "Định tuyến mô hình",
  "settings.providers.routing.title": "Chiến lược định tuyến",
  "settings.providers.routing.description": "OpenRouter chọn nhà cung cấp nền tảng cho mỗi yêu cầu như thế nào.",
  "settings.providers.routing.price": "Giá thấp nhất",
  "settings.providers.routing.throughput": "Thông lượng cao nhất",
  ...
  "settings.plugins.plugins.add.browse": "Duyệt…",
  ...
  "settings.plugins.skills.directories.title": "Thư mục kỹ năng",
  "settings.plugins.skills.directories.hint":
    "Tắt một thư mục để loại bỏ các kỹ năng của nó khỏi việc khám phá. Các tệp vẫn được giữ trên đĩa.",
  "settings.plugins.skills.directories.toggle": "Bật/tắt thư mục kỹ năng {{directory}}",
  "settings.plugins.skills.directories.disabled": "Tắt",
  "settings.plugins.skills.directories.toggle.failed": "Không thể cập nhật các thư mục kỹ năng",
