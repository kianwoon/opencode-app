export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Màu chữ của tin nhắn người dùng",
  "settings.general.row.userMessageTextColor.description": "Đặt màu chữ của tin nhắn người dùng",
