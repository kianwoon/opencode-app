...
export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Vartotojo pranešimų teksto spalva",
  "settings.general.row.userMessageTextColor.description": "Nustatykite vartotojo pranešimų teksto spalvą",
