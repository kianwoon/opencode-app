...
export const dict = {
  ...
  "command.session.search": "Ieškoti pranešimų",
  "command.session.search.description": "Ieškoti pranešimų šiame seanse",
  ...
  "dialog.search.empty": "Nėra atitinkančių pranešimų",
  ...
  "settings.general.row.messageWidth.title": "Pranešimų plotis",
  "settings.general.row.messageWidth.description": "Nustatykite, kiek plačios gali būti naudotojo žinutės pokalbyje",
  "settings.general.row.messageWidth.option.default": "Numatytasis",
  "settings.general.row.messageWidth.option.wide": "Platus",
  ...
  "settings.general.row.messageAlign.option.right": "Dešinėje",
  "settings.general.row.messageBorder.title": "Pranešimų rėmelis",
  "settings.general.row.messageBorder.description": "Nustatykite vartotojo pranešimų rėmelio spalvą ir storį",
  "settings.general.row.messageBorder.width.none": "Nėra",
  "settings.general.row.messageBackground.title": "Pranešimų fonas",
  "settings.general.row.messageBackground.description": "Nustatykite vartotojo pranešimų fono spalvą",
  "settings.general.row.userMessageFont.title": "Vartotojo pranešimų teksto spalva",
  "settings.general.row.userMessageFont.description": "Nustatykite vartotojo pranešimų teksto spalvą",
  ...
  "settings.providers.section.routing": "Modelių maršrutizavimas",
  "settings.providers.routing.title": "Maršrutizavimo strategija",
  "settings.providers.routing.description": "Kaip OpenRouter parenka serverio teikėją kiekvienai užklausai.",
  "settings.providers.routing.price": "Žemiausia kaina",
  "settings.providers.routing.throughput": "Didžiausias pralaidumas",
  ...
  "settings.plugins.plugins.add.browse": "Naršyti…",
  ...
  "settings.plugins.skills.directories.title": "Įgūdžių katalogai",
  "settings.plugins.skills.directories.hint":
    "Išjungus katalogą, jo įgūdžiai neįtraukiami į aptikimą. Failai lieka diske.",
  "settings.plugins.skills.directories.toggle": "Perjungti įgūdžių katalogą {{directory}}",
  "settings.plugins.skills.directories.disabled": "Išjungta",
  "settings.plugins.skills.directories.toggle.failed": "Nepavyko atnaujinti įgūdžių katalogų",
  ...
  "settings.plugins.skills.count.many": "{{count}} įgūdžių",
