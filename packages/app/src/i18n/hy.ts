export const dict = {
  ...
  "command.session.search": "Որոնել հաղորդագրություններ",
  "command.session.search.description": "Որոնել հաղորդագրություններ այս նիստում",
  ...
  "dialog.search.empty": "Համապատասխան հաղորդագրություններ չկան",
  ...
  "settings.general.row.messageWidth.title": "Հաղորդագրության լայնություն",
  "settings.general.row.messageWidth.description": "Որոշեք՝ որքան լայն կարող են լինել օգտատիրոջ հաղորդագրությունները զրույցում",
  "settings.general.row.messageWidth.option.default": "Կանխադրված",
  "settings.general.row.messageWidth.option.wide": "Լայն",
  ...
  "settings.general.row.messageAlign.option.center": "Կենտրոն",
  "settings.general.row.messageAlign.option.right": "Աջ",
  "settings.general.row.messageBorder.title": "Հաղորդագրությունների եզրագիծ",
  "settings.general.row.messageBorder.description": "Սահմանեք օգտագործողի հաղորդագրությունների եզրագծի գույնն ու հաստությունը",
  "settings.general.row.messageBorder.width.none": "Ոչ մի",
  "settings.general.row.messageBackground.title": "Հաղորդագրությունների ֆոն",
  "settings.general.row.messageBackground.description": "Սահմանեք օգտագործողի հաղորդագրությունների ֆոնի գույնը",
  "settings.general.row.userMessageFont.title": "Օգտագործողի հաղորդագրությունների տեքստի գույն",
  "settings.general.row.userMessageFont.description": "Սահմանեք օգտագործողի հաղորդագրությունների տեքստի գույնը",
  ...
  "settings.general.row.fontWeight.extraLight": "Ծայրահեղ բաց",
  "settings.general.row.fontWeight.light": "Բաց",
  "settings.general.row.fontWeight.regular": "Սովորական",
  ...
  "settings.providers.section.routing": "Մոդելների երթուղիավորում",
  "settings.providers.routing.title": "Երթուղիավորման ռազմավարություն",
  "settings.providers.routing.description":
    "OpenRouter-ը ինչպես է ընտրում հետևյալ մատակարարիչը յուրաքանչյուր հարցման համար։",
  "settings.providers.routing.price": "Ամենացածր գին",
  "settings.providers.routing.throughput": "Ամենաբարձր թողունակություն",
  ...
  "settings.plugins.plugins.add.browse": "Թերթել…",
