export const dict = {
  ...
  "settings.general.row.userMessageTextColor.title": "Օգտագործողի հաղորդագրությունների տեքստի գույն",
  "settings.general.row.userMessageTextColor.description": "Սահմանեք օգտագործողի հաղորդագրությունների տեքստի գույնը",
